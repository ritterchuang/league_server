...
import org.lsj.gs.mathStr.core.entity.playStr.gameResultExtend.baiRen.GameResultExtend132CjnnJava;
...
// 一般新超級牛牛局產生器
public class BoardGtrBaiRenCjnnJavaNormal extends AbstractBoardGtrBaiRenCjnnJava {
    public BoardGtrBaiRenCjnnJavaNormal(GamePlayerSimulation player, PoolCtr poolCtr, PlayGameFieldConfig playGameFieldConfig, ControlAlgorithmConfig controlAlgorithmConfig) {
    ...
    public BoardGtrResult calculateOneBoardResult() {
        ...
        // 4. 計算客製結果
        GameResultExtend132CjnnJava gameResultExtend = this.calculateGameResultExtend();

        // 5. 回傳局結果
        return new BoardGtrResult(super.calculateStatisticResult(), gameBetLogResult, gameResultExtend);
    }

    private GameResultExtend132CjnnJava calculateGameResultExtend() {
        return new GameResultExtend132CjnnJava(
