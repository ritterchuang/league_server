...
// 遊戲中心管理器設定資源 122 新搶莊牌九 正常模擬
public class GameCenterMgrR122QzpjJavaNormal {
    public GameCenterMgrConfig create(){
        return new GameCenterMgrConfig(
            new PlayGameFieldConfig[]{
                    new PlayGameFieldConfigReader().getConfig(ConstPlayGameField.PlayGameFieldResource.R122_QZPJ_JAVA_NORMAL)
            }
        );
    }
}
