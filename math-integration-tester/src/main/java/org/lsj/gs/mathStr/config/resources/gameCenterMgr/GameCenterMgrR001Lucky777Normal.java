...
// 遊戲中心管理器設定資源 001 Lucky777 正常模擬
public class GameCenterMgrR001Lucky777Normal {
    public GameCenterMgrConfig create(){
        return new GameCenterMgrConfig(
            new PlayGameFieldConfig[]{
                    new PlayGameFieldConfigReader().getConfig(ConstPlayGameField.PlayGameFieldResource.R001_LUCKY777_NORMAL)
            }
        );
    }
}
