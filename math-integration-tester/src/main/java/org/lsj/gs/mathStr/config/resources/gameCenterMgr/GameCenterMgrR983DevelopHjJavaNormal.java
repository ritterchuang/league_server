...
// 遊戲中心管理器設定資源 983 開發虎機 正常模擬
public class GameCenterMgrR983DevelopHjJavaNormal {
    public GameCenterMgrConfig create(){
        return new GameCenterMgrConfig(
            new PlayGameFieldConfig[]{
                    new PlayGameFieldConfigReader().getConfig(ConstPlayGameField.PlayGameFieldResource.R983_DEVELOP_HJ_JAVA_NORMAL)
            }
        );
    }
}
