...
// 遊戲中心管理器設定資源 114 新搶莊二八槓 正常模擬
public class GameCenterMgrR114EbgJavaNormal {
    public GameCenterMgrConfig create(){
        return new GameCenterMgrConfig(
            new PlayGameFieldConfig[]{
                    new PlayGameFieldConfigReader().getConfig(ConstPlayGameField.PlayGameFieldResource.R114_EBG_JAVA_NORMAL)
            }
        );
    }
}
