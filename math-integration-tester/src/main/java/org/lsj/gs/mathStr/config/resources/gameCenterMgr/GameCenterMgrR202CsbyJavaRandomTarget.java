...
// 遊戲中心管理器設定資源 202 財神捕魚 正常模擬
public class GameCenterMgrR202CsbyJavaRandomTarget {
    public GameCenterMgrConfig create(){
        return new GameCenterMgrConfig(
            new PlayGameFieldConfig[]{
                    new PlayGameFieldConfigReader().getConfig(ConstPlayGameField.PlayGameFieldResource.R202_CSBY_JAVA_RANDOM_TARGET)
            }
        );
    }
}
