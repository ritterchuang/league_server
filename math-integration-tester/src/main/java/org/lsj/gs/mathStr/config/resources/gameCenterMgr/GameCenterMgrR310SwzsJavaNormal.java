...
// 遊戲中心管理器設定資源 310 死亡之書 正常模擬
public class GameCenterMgrR310SwzsJavaNormal {
    public GameCenterMgrConfig create(){
        return new GameCenterMgrConfig(
            new PlayGameFieldConfig[]{
                    new PlayGameFieldConfigReader().getConfig(ConstPlayGameField.PlayGameFieldResource.R310_SWZS_JAVA_NORMAL)
            }
        );
    }
}
