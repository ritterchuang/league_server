...
// 遊戲中心管理器設定資源 306 寶石之星 正常模擬
public class GameCenterMgrR306BszxJavaNormal {
    public GameCenterMgrConfig create(){
        return new GameCenterMgrConfig(
            new PlayGameFieldConfig[]{
                    new PlayGameFieldConfigReader().getConfig(ConstPlayGameField.PlayGameFieldResource.R306_BSZX_JAVA_NORMAL)
            }
        );
    }
}
