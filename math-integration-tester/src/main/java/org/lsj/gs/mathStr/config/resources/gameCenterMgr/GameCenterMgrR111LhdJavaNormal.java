...
// 遊戲中心管理器設定資源 111 新龍虎鬥 正常模擬
public class GameCenterMgrR111LhdJavaNormal {
    public GameCenterMgrConfig create(){
        return new GameCenterMgrConfig(
            new PlayGameFieldConfig[]{
                    new PlayGameFieldConfigReader().getConfig(ConstPlayGameField.PlayGameFieldResource.R111_LHD_JAVA_NORMAL)
            }
        );
    }
}
