...
// 亂數產生器設定 307 777
public class RndGtrR307CccJava extends AbstractRndGtrR {
    public RngDataGtrConfig create(){
        return new RngDataGtrConfig(
                new RngDataScenarioHlrConfig(1000000),
                new BoardGtrConfigFactory().create(ConstPlayGameField.PlayGameFieldResource.R307_CCC_JAVA_NORMAL, ConstBoardGtr.BoardGtrControlAlgorithmType.NATURE),
