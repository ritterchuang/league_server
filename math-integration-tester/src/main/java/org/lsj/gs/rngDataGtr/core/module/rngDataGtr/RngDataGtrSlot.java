...
// 虎機亂數產生器
public class RngDataGtrSlot extends AbstractRngDataGtr{

    public RngDataGtrSlot(RngDataGtrConfig rngDataGtrConfig) {
    ...
    public List<TestCaseGameResult> run(){
        ...
        // 1. 建立局產生器
        IBoardGtrSlot boardGtrSlot = new BoardGtrFactory(super.getRngDataGtrConfig().getBoardGtrConfig().getGamePlayer(),
