...
// 亂數產生器設定 315 黃金西部
public class RndGtrR315HjxbJava extends AbstractRndGtrR {
    public RngDataGtrConfig create(){
        return new RngDataGtrConfig(
                new RngDataScenarioHlrConfig(1000000),
                new BoardGtrConfigFactory().create(ConstPlayGameField.PlayGameFieldResource.R315_HJXB_JAVA_NORMAL, ConstBoardGtr.BoardGtrControlAlgorithmType.NATURE),
