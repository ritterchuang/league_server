...
// 亂數產生器設定 001 Lucky777
public class RndGtrR001Lucky777 extends AbstractRndGtrR {
    public RngDataGtrConfig create(){
        return new RngDataGtrConfig(
                new RngDataScenarioHlrConfig(1000000),
                new BoardGtrConfigFactory().create(ConstPlayGameField.PlayGameFieldResource.R001_LUCKY777_NORMAL, ConstBoardGtr.BoardGtrControlAlgorithmType.NATURE),
