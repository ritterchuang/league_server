...
// 亂數產生器設定 303 聖誕任務
public class RndGtrR310SwzsJava extends AbstractRndGtrR {
    public RngDataGtrConfig create(){
        return new RngDataGtrConfig(
                new RngDataScenarioHlrConfig(1000000),
                new BoardGtrConfigFactory().create(ConstPlayGameField.PlayGameFieldResource.R310_SWZS_JAVA_NORMAL, ConstBoardGtr.BoardGtrControlAlgorithmType.NATURE),
