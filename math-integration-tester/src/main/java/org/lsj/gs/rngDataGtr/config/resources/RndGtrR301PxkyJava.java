...
// 亂數產生器設定 301 貔貅開運
public class RndGtrR301PxkyJava extends AbstractRndGtrR {
    public RngDataGtrConfig create(){
        return new RngDataGtrConfig(
                new RngDataScenarioHlrConfig(1000000),
                new BoardGtrConfigFactory().create(ConstPlayGameField.PlayGameFieldResource.R301_PXKY_JAVA_NORMAL, ConstBoardGtr.BoardGtrControlAlgorithmType.NATURE),
