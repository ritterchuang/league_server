package com.lx.gs.rngDataGtr.config.entity.rngDataTester.testCase;

import com.lx.gs.math.core.slot.ConstMathSlot;

// 客製測項設定 消除虎機 賠率表連線測項
public class TestCaseConfigESlotCascadeWayGame extends AbstractTestCaseConfigExtend {
    ...
    public TestCaseConfigESlotCascadeWayGame(int payComboId, int hitNumber, ConstMathSlot.GameStateType gameStateType) {
