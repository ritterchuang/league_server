...
// 遊戲中心管理器設定資源 126 新看四張搶莊牛牛 正常模擬
public class GameCenterMgrR126QznnK4zJavaNormal {
    public GameCenterMgrConfig create(){
        return new GameCenterMgrConfig(
            new PlayGameFieldConfig[]{
                    new PlayGameFieldConfigReader().getConfig(ConstPlayGameField.PlayGameFieldResource.R126_QZNN_K4Z_JAVA_NORMAL)
            }
        );
    }
}
