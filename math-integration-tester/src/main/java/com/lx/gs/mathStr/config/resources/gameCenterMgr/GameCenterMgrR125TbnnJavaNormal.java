...
// 遊戲中心管理器設定資源 115 新看三張搶莊牛牛 正常模擬
public class GameCenterMgrR125TbnnJavaNormal {
    public GameCenterMgrConfig create(){
        return new GameCenterMgrConfig(
            new PlayGameFieldConfig[]{
                    new PlayGameFieldConfigReader().getConfig(ConstPlayGameField.PlayGameFieldResource.R125_TBNN_JAVA_NORMAL)
            }
        );
    }
}
