package com.lx.gs.math.games.qznn_ksz_java.module.logic;
...
import com.lx.gs.math.core.common.logic.logicCard.AbstractLogicQzNn;
...
import com.lx.gs.math.games.qznn_ksz_java.module.niu.NiuStackTmrQznnKszJava;

import java.util.ArrayList;

// 新看三張搶莊牛牛邏輯
public class LogicQznnKszJava extends AbstractLogicQzNn implements ILogicQznnKszJava {
    private final NiuStackTmrQznnKszJava niuStackTmr; // 牛牛牌型轉換器

    public LogicQznnKszJava(TableQznnKszJava table,
        ...
        // 2. 模組初始化
        this.niuStackTmr = new NiuStackTmrQznnKszJava(tableGameConfig.getNiuStackTmrConfigQznnKszJava().getNiuTypeTransformMap()); // 牛型轉換器
    }
    ...
    // 取得真人選牌結果
    @Override
    public NiuStackQznnKszJava getHumanPlayerSelectResult() { return this.niuStackTmr.transformNiuStack(super.getHumanPlayerSelectResultCommon()); }
