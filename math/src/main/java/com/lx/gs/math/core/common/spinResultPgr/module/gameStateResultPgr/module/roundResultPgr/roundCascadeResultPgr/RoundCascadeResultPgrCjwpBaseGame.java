...
// 客製局結果包裝者消除 超級王牌基礎遊戲
public class RoundCascadeResultPgrCjwpBaseGame implements IRoundResultPgr {
    ...
    public RoundCascadeResultPgrCjwpBaseGame(ClientRoundResultPgrConfig config, ITableUtil tableUtil) {
