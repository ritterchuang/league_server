...
// 客製局結果包裝者消除 羅馬競技場基礎遊戲
public class RoundCascadeResultPgrLmjjcBaseGame implements IRoundResultPgr {
    ...
    public RoundCascadeResultPgrLmjjcBaseGame(ClientRoundResultPgrConfig config, ITableUtil tableUtil) {
