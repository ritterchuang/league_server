...
// 消除類連續消除7次
public class SpecialFeatureHlr_12 extends AbstractSpecialFeatureHlr implements ISpecialFeatureHlr{
    private final int targetNumber = 7; // 目標消除數量
    private final SpecialFeatureHlrConfig config; // 設定檔
    private final ITableUtil tableUtil; // 牌桌工具包

    public SpecialFeatureHlr_12(SpecialFeatureHlrConfig specialFeatureHlrConfig, ITableUtil tableUtil) {
