...
// 客製局結果包裝者消除 麻將無雙基礎遊戲
public class RoundCascadeResultPgrMjwsBaseGame implements IRoundResultPgr {
    ...
    public RoundCascadeResultPgrMjwsBaseGame(ClientRoundResultPgrConfig config, ITableUtil tableUtil) {
