package com.lx.gs.math.games.swzs_java.module.gameStateHlr;
...
import com.lx.gs.math.core.slot.mathSlotConfigHlr.enity.sever.roundConfig.roundNormalGameConfig.RoundNormalGameConfigExtendSwzsBaseGame;
...
import com.lx.gs.math.games.swzs_java.entity.config.GameStateConfigExtendSwzsBaseGame;
import com.lx.gs.math.games.swzs_java.entity.result.gameStateResult.GameStateHlrResultExtendSwzsBaseGame;
import com.lx.utils.MathUtil;

import java.util.ArrayList;

// 死亡之書虎機 基本遊戲處理者
public class GameStateHlrSwzsBaseGame extends AbstractGameStateHlr implements IGameStateHlr {
    private final LogicSlotNormal logic; // 牌桌邏輯
    private final GameStateConfigExtendSwzsBaseGame gameStateConfigExtend; // 遊戲狀態額外設定
    private final RoundNormalGameConfigExtendSwzsBaseGame roundConfigExtend; // 遊戲場次額外設定

    public GameStateHlrSwzsBaseGame(int conditionId, int gameStateId, ITableUtilSlot tableUtil, ILogicSlot logic, GameStateConfig gameStateConfig) {
        super(conditionId, gameStateId, gameStateConfig, tableUtil);
        this.logic = (LogicSlotNormal) logic;
        this.gameStateConfigExtend = (GameStateConfigExtendSwzsBaseGame) gameStateConfig.getGameStateConfigExtend();
        this.roundConfigExtend = (RoundNormalGameConfigExtendSwzsBaseGame) ((RoundConfigNormal)gameStateConfig.getRoundConfig()).getRoundNormalGameConfigExtend();
    }
    ...
    public GameStateHlrResult calculateGameStateHlrResult(int gameStateResultIndex, ConstMathSlot.ReelRtpType reelRtpType, SpinRequest spinRequest, GameStateHlrResult beforeGameStateHlrResult) {
        ...
        return new GameStateHlrResult(
                ...
                new GameStateHlrResultExtendSwzsBaseGame(),
