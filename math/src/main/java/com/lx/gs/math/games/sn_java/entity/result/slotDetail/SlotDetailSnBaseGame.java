package com.lx.gs.math.games.sn_java.entity.result.slotDetail;

import com.lx.gs.math.core.slot.slotDetailHlrMgr.enity.SlotDetail;

// 虎機詳細記錄水牛基本遊戲
public class SlotDetailSnBaseGame extends SlotDetail {
    ...
    public SlotDetailSnBaseGame(double spinCost, double baseGameTotalWin, String screenColumn_1, String screenColumn_2, String screenColumn_3, String screenColumn_4, String screenColumn_5) {
