package com.lx.gs.math.games.hhdz_java.module.robotLogic;
...
import com.lx.gs.math.core.common.logic.logicBaiRen.AbstractLogicBaiRen;
import com.lx.gs.math.core.common.logic.logicBaiRen.AbstractLogicBaiRenJh;
...
import com.lx.gs.math.core.common.robotLogic.module.AbstractRobotLogic;
...
// 新紅黑大戰機器人邏輯
public class RobotLogicHhdzJava extends AbstractRobotLogic {
    ...
    private int calculateRandomAreaId(GamePlayer gamePlayer){
        // 1. 押龍則不能押虎
        if(this.calculateRobotAreaBetArray(gamePlayer.getChairIndex())[ConstHhdzJava.BetAreaIdHhdzJava.BLACK.getCode()] > 0){
        ...
        // 2. 押虎則不能押龍
        if(this.calculateRobotAreaBetArray(gamePlayer.getChairIndex())[ConstHhdzJava.BetAreaIdHhdzJava.RED.getCode()] > 0){
            return super.tableUtil.getNotSupportSetRngDataRandomUtil().getRandomElement(
                    Arrays.stream(ConstHhdzJava.BetAreaIdHhdzJava.values()).filter(betAreaEnum ->
                                    betAreaEnum.getCode() != ConstHhdzJava.BetAreaIdHhdzJava.INVALID.getCode()
