package com.lx.gs.math.games.lll_java.entity.result.roundResult;
...
// 客製遊戲局額外結果龍龍龍基礎遊戲
public class RoundHlrResultExtendLllBaseGame extends RoundHlrResultExtend {
    ...
    public RoundHlrResultExtendLllBaseGame(double totalWin, List<Integer> reSpinStrip, ScreenGtrResult screenGtrResult, GameCtrResult reSpinGameCtrResult) {
        super(totalWin);
