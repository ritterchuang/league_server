...
import com.lx.gs.math.core.card.betCtr.tbBetCtr.TbBetCtrConfig;
...
import com.lx.gs.math.core.card.resultCtr.niuResultCtr.NiuTonbiResultCtr;
import com.lx.gs.math.core.card.resultCtr.niuResultCtr.NiuTonbiResultCtrConfig;
import com.lx.gs.math.core.card.stackCtr.niuStackCtr.AbstractNiuStack;
import com.lx.gs.math.core.card.stackCtr.niuStackCtr.NiuStackCtr;
...
// 抽象通比牛牛類邏輯
public abstract class AbstractLogicTbNn extends AbstractLogicTb implements ILogicNn {
    private final CardWallCtr cardWallCtr; // 發牌計算器
    private final NiuStackCtr niuStackCtr; // 牛牛牌型計算器
    private final NiuTonbiResultCtr niuResultCtr; // 牛牛結果計算器

    public AbstractLogicTbNn(ITableBase table,
                             ...
                             NiuTonbiResultCtrConfig niuTonbiResultCtrConfig
                             ) {
        super(table, tableFieldConfig, gamePlayerHlr, poolCtr, gameBetLogResultCtrCard, tableUtil, tbBetCtrConfig);
        ...
        this.niuResultCtr = new NiuTonbiResultCtr(niuTonbiResultCtrConfig, gamePlayerHlr, poolCtr, tableUtil); // 算分模組
    }
