package com.lx.gs.math.config.resources.tableGameConfig.games.qznn_k4z_java;
...
import com.lx.gs.math.core.card.betCtr.qzBetCtr.QzBetCtrGameConfigBetType01;
import com.lx.gs.math.core.card.cardWallCtr.CardWallCtrGameConfig;
import com.lx.gs.math.core.card.resultCtr.niuResultCtr.NiuBankerResultCtrGameConfig;
import com.lx.gs.math.core.card.stackCtr.niuStackCtr.ConstNiu;
import com.lx.gs.math.core.card.stackCtr.niuStackCtr.NiuStackCtrGameConfig;
import com.lx.gs.math.core.card.vieBankerCtr.VieBankerCtrGameConfig;
import com.lx.gs.math.core.card.vieBankerCtr.VieBankerCtrGameConfigRateList;
...
import com.lx.gs.math.games.qznn_k4z_java.entity.ConstQznnK4zJava;
import com.lx.gs.math.games.qznn_k4z_java.module.niu.NiuStackTmrConfigQznnK4zJava;
...
// 新看四張搶莊牛牛預設 牌桌遊戲設定
public class TableGameResourceQznnK4zJavaDefault extends AbstractTableGameResourceCard {
    public TableGameConfigQznnK4zJava create() {
        // 1. 計算遊戲調控設定
        ...
        // 8. 計算牛型轉換器設定
        NiuStackTmrConfigQznnK4zJava niuStackTmrConfig = new NiuStackTmrConfigQznnK4zJava(
                new HashMap<>() {{
                    put(ConstNiu.NiuTypeEnumCommon.INVALID, ConstQznnK4zJava.NiuTypeEnumQznnK4zJava.INVALID);
                    put(ConstNiu.NiuTypeEnumCommon.NIU_0, ConstQznnK4zJava.NiuTypeEnumQznnK4zJava.NIU_0);
                    put(ConstNiu.NiuTypeEnumCommon.NIU_1, ConstQznnK4zJava.NiuTypeEnumQznnK4zJava.NIU_1);
                    put(ConstNiu.NiuTypeEnumCommon.NIU_2, ConstQznnK4zJava.NiuTypeEnumQznnK4zJava.NIU_2);
                    put(ConstNiu.NiuTypeEnumCommon.NIU_3, ConstQznnK4zJava.NiuTypeEnumQznnK4zJava.NIU_3);
                    put(ConstNiu.NiuTypeEnumCommon.NIU_4, ConstQznnK4zJava.NiuTypeEnumQznnK4zJava.NIU_4);
                    put(ConstNiu.NiuTypeEnumCommon.NIU_5, ConstQznnK4zJava.NiuTypeEnumQznnK4zJava.NIU_5);
                    put(ConstNiu.NiuTypeEnumCommon.NIU_6, ConstQznnK4zJava.NiuTypeEnumQznnK4zJava.NIU_6);
                    put(ConstNiu.NiuTypeEnumCommon.NIU_7, ConstQznnK4zJava.NiuTypeEnumQznnK4zJava.NIU_7);
                    put(ConstNiu.NiuTypeEnumCommon.NIU_8, ConstQznnK4zJava.NiuTypeEnumQznnK4zJava.NIU_8);
                    put(ConstNiu.NiuTypeEnumCommon.NIU_9, ConstQznnK4zJava.NiuTypeEnumQznnK4zJava.NIU_9);
                    put(ConstNiu.NiuTypeEnumCommon.NIU_NIU, ConstQznnK4zJava.NiuTypeEnumQznnK4zJava.NIU_NIU);
                    put(ConstNiu.NiuTypeEnumCommon.FLOWER_4, ConstQznnK4zJava.NiuTypeEnumQznnK4zJava.FLOWER_4);
                    put(ConstNiu.NiuTypeEnumCommon.SHUNZI_NIU, ConstQznnK4zJava.NiuTypeEnumQznnK4zJava.SHUNZI_NIU);
                    put(ConstNiu.NiuTypeEnumCommon.TONGHUA_NIU, ConstQznnK4zJava.NiuTypeEnumQznnK4zJava.TONGHUA_NIU);
                    put(ConstNiu.NiuTypeEnumCommon.HULU_NIU, ConstQznnK4zJava.NiuTypeEnumQznnK4zJava.HULU_NIU);
                    put(ConstNiu.NiuTypeEnumCommon.FLOWER_5, ConstQznnK4zJava.NiuTypeEnumQznnK4zJava.FLOWER_5);
                    put(ConstNiu.NiuTypeEnumCommon.BOMB, ConstQznnK4zJava.NiuTypeEnumQznnK4zJava.BOMB);
                    put(ConstNiu.NiuTypeEnumCommon.SHUNJIN_NIU, ConstQznnK4zJava.NiuTypeEnumQznnK4zJava.SHUNJIN_NIU);
                    put(ConstNiu.NiuTypeEnumCommon.SMALL_NIU, ConstQznnK4zJava.NiuTypeEnumQznnK4zJava.SMALL_NIU);
                }}
        );

        // 9. 搶莊類機器人邏輯設定
        RobotLogicConfigBanker robotLogicConfig = new RobotLogicConfigBanker(
                new ArrayList<>(){{
                ...
                ConstQznnK4zJava.TimeEnumQznnK4zJava.VIE_BANKER.getMilliTimeSec(),
                ConstQznnK4zJava.TimeEnumQznnK4zJava.BET.getMilliTimeSec(),
                ConstQznnK4zJava.TimeEnumQznnK4zJava.SELECT.getMilliTimeSec()
        );

        return new TableGameConfigQznnK4zJava(
                gameAdjustConfig,
                rngAlgorithmConfig,
    ...
    private Map<ConstNiu.NiuTypeEnumCommon, Integer> getNiuTypeRateConfig(){
        return new HashMap<>(){{
            ...
            put(ConstNiu.NiuTypeEnumCommon.SHUNJIN_NIU, 4);
