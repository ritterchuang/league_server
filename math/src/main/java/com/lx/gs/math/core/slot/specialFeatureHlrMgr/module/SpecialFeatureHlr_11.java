...
// 消除類連續消除6次
public class SpecialFeatureHlr_11 extends AbstractSpecialFeatureHlr implements ISpecialFeatureHlr{
    private final int targetNumber = 6; // 目標消除數量
    private final SpecialFeatureHlrConfig config; // 設定檔
    private final ITableUtil tableUtil; // 牌桌工具包

    public SpecialFeatureHlr_11(SpecialFeatureHlrConfig specialFeatureHlrConfig, ITableUtil tableUtil) {
