package com.lx.gs.math.games.bszx_java.module.gameStateHlr;
...
import com.lx.gs.math.core.slot.mathSlotConfigHlr.enity.sever.roundConfig.roundNormalGameConfig.RoundNormalGameConfigExtendBszxFreeGame;
...
import com.lx.gs.math.games.bszx_java.enity.config.GameStateConfigExtendBszxFreeGame;
import com.lx.gs.math.games.bszx_java.enity.result.gameStateResult.GameStateHlrResultExtendBszxBaseGame;
import com.lx.utils.MathUtil;

import java.util.ArrayList;

// 寶石之星虎機 免費遊戲處理者
public class GameStateHlrBszxFreeGame extends AbstractGameStateHlr implements IGameStateHlr {
    private final LogicSlotNormal logic; // 牌桌邏輯
    private final GameStateConfigExtendBszxFreeGame gameStateConfigExtend; // 遊戲狀態額外設定
    private final RoundNormalGameConfigExtendBszxFreeGame roundConfigExtend; // 遊戲場次額外設定

    public GameStateHlrBszxFreeGame(int conditionId, int gameStateId, ITableUtilSlot tableUtil, ILogicSlot logic, GameStateConfig gameStateConfig) {
        super(conditionId, gameStateId, gameStateConfig, tableUtil);
        this.logic = (LogicSlotNormal) logic;
        this.gameStateConfigExtend = (GameStateConfigExtendBszxFreeGame) gameStateConfig.getGameStateConfigExtend();
        this.roundConfigExtend = (RoundNormalGameConfigExtendBszxFreeGame) ((RoundConfigNormal)gameStateConfig.getRoundConfig()).getRoundNormalGameConfigExtend();
    }
    ...
    public GameStateHlrResult calculateGameStateHlrResult(int gameStateResultIndex, ConstMathSlot.ReelRtpType reelRtpType, SpinRequest spinRequest, GameStateHlrResult beforeGameStateHlrResult) {
        ...
        return new GameStateHlrResult(
                ...
                new GameStateHlrResultExtendBszxBaseGame(),
