...
// 虎機詳細記錄計算者額外設定 帝国榮耀免費遊戲
public class SlotDetailHlrConfigExtendDgryFreeGame extends SlotDetailHlrConfigExtend {
    private final SymbolConfig symbolConfig; // 標誌設定

    public SlotDetailHlrConfigExtendDgryFreeGame(Map<Integer, String> symbolIdToStringMap, FrameConfig frameConfig, ReelConfig reelConfig, SymbolConfig symbolConfig) {
