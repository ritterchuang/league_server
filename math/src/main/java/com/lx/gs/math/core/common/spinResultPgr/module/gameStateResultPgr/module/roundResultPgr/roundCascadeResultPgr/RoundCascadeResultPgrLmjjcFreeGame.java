...
// 客製局結果包裝者消除 羅馬競技場免費遊戲
public class RoundCascadeResultPgrLmjjcFreeGame implements IRoundResultPgr {
    ...
    public RoundCascadeResultPgrLmjjcFreeGame(ClientRoundResultPgrConfig config, ITableUtil tableUtil) {
