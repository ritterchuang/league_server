package com.lx.gs.math.games.cjwp_java.entity.config;
...
// 虎機詳細記錄計算者額外設定 超級王牌基本遊戲
public class SlotDetailHlrConfigExtendCjwpBaseGame extends SlotDetailHlrConfigExtend {
    private final SymbolConfig symbolConfig; // 標誌設定

    public SlotDetailHlrConfigExtendCjwpBaseGame(Map<Integer, String> symbolIdToStringMap, FrameConfig frameConfig, ReelConfig reelConfig, SymbolConfig symbolConfig) {
