package com.lx.gs.math.games._model_hj_java.enity.config;
...
// 虎機詳細記錄計算者額外設定 模板虎機免費遊戲
public class SlotDetailHlrConfigExtendModelHjFreeGame extends SlotDetailHlrConfigExtend {
    private final SymbolConfig symbolConfig; // 標誌設定

    public SlotDetailHlrConfigExtendModelHjFreeGame(Map<Integer, String> symbolIdToStringMap, FrameConfig frameConfig, ReelConfig reelConfig, SymbolConfig symbolConfig) {
