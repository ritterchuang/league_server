package com.lx.gs.math.games.bszx_java.enity.result.slotDetail;

import com.lx.gs.math.core.slot.slotDetailHlrMgr.enity.SlotDetail;

// 虎機詳細記錄聖誕寶石之星 基本遊戲
public class SlotDetailBszxBaseGame extends SlotDetail {
    ...
    public SlotDetailBszxBaseGame(double spinCost, double baseGameTotalWin, String screenColumn_1, String screenColumn_2, String screenColumn_3, String screenColumn_4, String screenColumn_5) {
