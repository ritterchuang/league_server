...
// 虎機詳細記錄計算者額外設定 帝国榮耀基本遊戲
public class SlotDetailHlrConfigExtendDgryBaseGame extends SlotDetailHlrConfigExtend {
    private final SymbolConfig symbolConfig; // 標誌設定

    public SlotDetailHlrConfigExtendDgryBaseGame(Map<Integer, String> symbolIdToStringMap, FrameConfig frameConfig, ReelConfig reelConfig, SymbolConfig symbolConfig) {
