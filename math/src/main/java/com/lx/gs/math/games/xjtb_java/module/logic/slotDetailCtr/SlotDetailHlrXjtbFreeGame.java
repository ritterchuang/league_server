package com.lx.gs.math.games.xjtb_java.module.logic.slotDetailCtr;
...
import com.lx.gs.math.games.xjtb_java.entity.result.roundResult.RoundHlrResultExtendXjtbFreeGame;
import com.lx.gs.math.games.xjtb_java.entity.result.slotDetail.SlotDetailXjtbFreeGame;
...
// 虎機詳細記錄計算者仙境探寶
public class SlotDetailHlrXjtbFreeGame extends AbstractSlotDetailHlr implements ISlotDetailHlr {
    private final ConstMathSlot.SlotDetailType slotDetailType; // 虎機詳細記錄類型
    private final SlotDetailHlrConfigExtendXjtbFreeGame extendConfig; // 虎機詳細記錄額外設定

    public SlotDetailHlrXjtbFreeGame(SlotDetailHlrConfig slotDetailHlrConfig, ITableUtil tableUtil1) {
        super(slotDetailHlrConfig, tableUtil1);
        this.slotDetailType = slotDetailHlrConfig.getSlotDetailType();
        this.extendConfig = (SlotDetailHlrConfigExtendXjtbFreeGame) slotDetailHlrConfig.getSlotDetailHlrConfigExtend();
    }
    ...
    // 計算基礎遊戲詳細記錄
    private SlotDetailXjtbFreeGame calculateFreeGameDetailPerRound(RoundHlrResult roundHlrResult) {
        // 1. 取得轉型局結果
        ...
        // 13. 回傳
        return new SlotDetailXjtbFreeGame(
    ...
    private String calculateMultiplierListPerColumn(RoundHlrResultNormal roundHlrResultNormal, int columnIndex) {
        ...
        // 3. 取出額外結果
        RoundHlrResultExtendXjtbFreeGame roundHlrResultExtendXjtbFreeGame = (RoundHlrResultExtendXjtbFreeGame) roundHlrResultNormal.getRoundHlrResultExtend();
        List<Integer> multiplierListPerColumn = roundHlrResultExtendXjtbFreeGame.getMultiplierMatrix().get(columnIndex);
