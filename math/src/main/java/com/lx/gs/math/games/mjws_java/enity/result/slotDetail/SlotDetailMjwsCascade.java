package com.lx.gs.math.games.mjws_java.enity.result.slotDetail;

import com.lx.gs.math.core.slot.slotDetailHlrMgr.enity.SlotDetail;

// 虎機詳細記錄麻將無雙 消除內容
public class SlotDetailMjwsCascade extends SlotDetail {
    ...
    public SlotDetailMjwsCascade(int cascadeIndex, int cascadeMultiplier, double cascadeTotalWin, String screenColumn_1, String screenColumn_2, String screenColumn_3, String screenColumn_4, String screenColumn_5, String goldenPosition_2, String goldenPosition_3, String goldenPosition_4) {
