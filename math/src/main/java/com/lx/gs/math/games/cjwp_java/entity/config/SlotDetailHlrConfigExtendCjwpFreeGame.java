...
// 虎機詳細記錄計算者額外設定 超級王牌免費遊戲
public class SlotDetailHlrConfigExtendCjwpFreeGame extends SlotDetailHlrConfigExtend {
    private final SymbolConfig symbolConfig; // 標誌設定

    public SlotDetailHlrConfigExtendCjwpFreeGame(Map<Integer, String> symbolIdToStringMap, FrameConfig frameConfig, ReelConfig reelConfig, SymbolConfig symbolConfig) {
