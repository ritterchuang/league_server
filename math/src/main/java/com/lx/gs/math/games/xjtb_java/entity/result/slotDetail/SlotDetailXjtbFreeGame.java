package com.lx.gs.math.games.xjtb_java.entity.result.slotDetail;

import com.lx.gs.math.core.slot.slotDetailHlrMgr.enity.SlotDetail;

// 虎機詳細記錄仙境探寶免費遊戲
public class SlotDetailXjtbFreeGame extends SlotDetail {
    ...
    public SlotDetailXjtbFreeGame(int roundIndex, int totalRound, double roundTotalWin, String screenColumn_1, String screenColumn_2, String screenColumn_3, String screenColumn_4, String screenColumn_5, String multiplier_2, String multiplier_3, String multiplier_4) {
