...
// 客製局結果包裝者消除 麻將無雙免費遊戲
public class RoundCascadeResultPgrMjwsFreeGame implements IRoundResultPgr {
    ...
    public RoundCascadeResultPgrMjwsFreeGame(ClientRoundResultPgrConfig config, ITableUtil tableUtil) {
