...
import com.lx.gs.math.games.hjxb_java.entity.result.roundResult.RoundResultExtendHjxbFreeGame;

import java.util.ArrayList;
import java.util.List;

// 客製局結果包裝者一般 黃金西部免費遊戲
public class RoundResultNormalPgrHjxbFreeGame extends AbstractRoundResultNormalPgr {

    public RoundResultNormalPgrHjxbFreeGame(ClientRoundResultPgrConfig config, ITableUtil tableUtil) {
    ...
    public RoundResultExtend packageRoundResultExtend(ScreenResult screenResult, RoundHlrResultNormal roundHlrResultNormal) {
        ...
        // 1. 取得畫面倍數陣列
        List<List<Integer>> multiplierMatrix = ((RoundHlrResultExtendHjxbFreeGame)roundHlrResultNormal.getRoundHlrResultExtend()).getMultiplierMatrix();
        ...
        // 4. 回傳
        return new RoundResultExtendHjxbFreeGame(positionIdToMultiplierList);
    }
}
