package com.lx.gs.math.config.resources.tableGameConfig.games.bjl_java;
...
// 新百家樂預設 牌桌遊戲設定
public class TableGameResourceBjlJavaDefault extends AbstractTableGameResourceCard {
    public TableGameConfigBjlJava create() {
        // 1. 計算遊戲調控設定
        ...
        // 7. 封裝
        return new TableGameConfigBjlJava(
                gameAdjustConfig,
                rngAlgorithmConfig,
                mathConfigHlrConfig,
