package com.lx.gs.math.games.xzcq_java.entity.result.roundResult;
...
// 客端客製遊戲局額外結果小豬傳奇基礎遊戲
public class RoundResultExtendXzcqBaseGame extends RoundResultExtend {
    ...
    public RoundResultExtendXzcqBaseGame(double totalWin, List<Integer> reSpinStrip, int reSpinStopIndex, GameResult reSpinGameResult) {
        super(totalWin);
