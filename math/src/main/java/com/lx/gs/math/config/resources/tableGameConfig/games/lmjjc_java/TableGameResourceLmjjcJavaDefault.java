package com.lx.gs.math.config.resources.tableGameConfig.games.lmjjc_java;
...
import com.lx.gs.math.core.slot.mathSlotConfigHlr.enity.sever.roundConfig.roundCascadeGameConfig.RoundCascadeGameConfigExtendLmjjcFreeGame;
...
import com.lx.gs.math.games.lmjjc_java.entity.config.GameStateConfigExtendLmjjcFreeGame;
...
// 羅馬競技場 牌桌遊戲設定產生器
public class TableGameResourceLmjjcJavaDefault extends AbstractTableGameResourceSlot {
    ...
    public TableGameConfigSlot create() {
        ...
        // 8. 設定遊戲狀態設定
        // 8.1 基礎遊戲狀態設定
        GameStateConfig lmjjcBaseGameStateConfig = new GameStateConfig(
                ConstMathSlot.GameStateType.LMJJC_BASEGAME,
                new GameStateConfigExtendLmjjcBaseGame(),
                ...
                new RoundConfigCascade(
                        ...
                        new RoundCascadeGameConfigExtendLmjjcBaseGame()
                ),
                ConstMathSlot.SlotDetailType.LMJJC_BASEGAME
        );

        // 8.2 免費遊戲狀態設定
        GameStateConfig lmjjcFreeGameStateConfig = new GameStateConfig(
                ConstMathSlot.GameStateType.LMJJC_FREEGAME,
                new GameStateConfigExtendLmjjcFreeGame(),
                new GameStateInputConfig(ConstMathSlot.GameStateInputType.NONE, new GameStateInputConfigExtendNone()),
                ConstMathSlot.RoundType.CASCADE,
                new RoundConfigCascade(
                        new ReelConfig(
                        ...
                        new RoundCascadeGameConfigExtendLmjjcFreeGame(3, 2)
                ),
                ConstMathSlot.SlotDetailType.LMJJC_FREEGAME
        );
        ...
        GameStateConfigCluster gameStateConfigCluster = new GameStateConfigCluster(
                ...
                List.of(lmjjcBaseGameStateConfig, lmjjcFreeGameStateConfig)
        );
