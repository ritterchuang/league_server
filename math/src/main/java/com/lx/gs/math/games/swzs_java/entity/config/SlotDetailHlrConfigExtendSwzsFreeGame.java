package com.lx.gs.math.games.swzs_java.entity.config;
...
// 虎機詳細記錄計算者額外設定 死亡之書虎機免費遊戲
public class SlotDetailHlrConfigExtendSwzsFreeGame extends SlotDetailHlrConfigExtend {
    private final SymbolConfig symbolConfig; // 標誌設定

    public SlotDetailHlrConfigExtendSwzsFreeGame(Map<Integer, String> symbolIdToStringMap, FrameConfig frameConfig, ReelConfig reelConfig, SymbolConfig symbolConfig) {
