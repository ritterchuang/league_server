package com.lx.gs.math.games.bjl_java.module.state;
...
// 遊戲開始狀態
public class StateGameBeginBjlJava extends AbstractStateBjlJava {
    private static final Logger LOG = LoggerFactory.getLogger(StateGameBeginBjlJava.class);
    public StateGameBeginBjlJava(TableBjlJava table, LogicBjlJava logic, RobotLogicBjlJava aiLogic, GameAdjustBjlJava gameAdjust, int stateId) {
    ...
    public class TimerTaskRobotAreaBet extends TimerTask {
        private final TableBjlJava table; // 牌桌
        private final AreaBetResultBaiRen areaBetResult; // 區域押注結果

        public TimerTaskRobotAreaBet(TableBjlJava table, AreaBetResultBaiRen areaBetResult){
            this.table = table;
