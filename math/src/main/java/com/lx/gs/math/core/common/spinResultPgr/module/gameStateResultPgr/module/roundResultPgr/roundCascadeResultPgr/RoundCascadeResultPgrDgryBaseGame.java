...
// 客製局結果包裝者消除 帝国榮耀基礎遊戲
public class RoundCascadeResultPgrDgryBaseGame implements IRoundResultPgr {
    ...
    public RoundCascadeResultPgrDgryBaseGame(ClientRoundResultPgrConfig config, ITableUtil tableUtil) {
