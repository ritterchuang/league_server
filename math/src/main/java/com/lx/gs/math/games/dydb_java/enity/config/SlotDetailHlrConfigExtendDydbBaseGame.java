package com.lx.gs.math.games.dydb_java.enity.config;
...
// 虎機詳細記錄計算者額外設定大運奪寶基礎遊戲
public class SlotDetailHlrConfigExtendDydbBaseGame extends SlotDetailHlrConfigExtend {
    private final SymbolConfig symbolConfig; // 標誌設定

    public SlotDetailHlrConfigExtendDydbBaseGame(Map<Integer, String> symbolIdToStringMap, FrameConfig frameConfig, ReelConfig reelConfig, SymbolConfig symbolConfig) {
