...
// 虎機詳細記錄計算者額外設定 寶石之星虎機免費遊戲
public class SlotDetailHlrConfigExtendBszxFreeGame extends SlotDetailHlrConfigExtend {
    private final SymbolConfig symbolConfig; // 標誌設定

    public SlotDetailHlrConfigExtendBszxFreeGame(Map<Integer, String> symbolIdToStringMap, FrameConfig frameConfig, ReelConfig reelConfig, SymbolConfig symbolConfig) {
