package com.lx.gs.math.games.hjxb_java.module.gameStateHlr;
...
import com.lx.gs.math.games.hjxb_java.entity.result.gameStateResult.GameStateHlrResultExtendHjxbBaseGame;
import com.lx.gs.math.games.hjxb_java.entity.result.roundResult.RoundHlrResultExtendHjxbFreeGame;
...
// 黃金西部免費遊戲處理者
public class GameStateHlrHjxbFreeGame extends AbstractGameStateHlr implements IGameStateHlr {
    private final LogicSlotNormal logic; // 牌桌邏輯
    private final GameStateConfigExtendHjxbFreeGame gameStateConfigExtend; // 遊戲狀態額外設定
    private final RoundNormalGameConfigExtendHjxbFreeGame roundConfigExtend; // 遊戲場次額外設定

    public GameStateHlrHjxbFreeGame(int conditionId, int gameStateId, ITableUtilSlot tableUtil, ILogicSlot logic, GameStateConfig gameStateConfig) {
        super(conditionId, gameStateId, gameStateConfig, tableUtil);
        this.logic = (LogicSlotNormal) logic;
        this.gameStateConfigExtend = (GameStateConfigExtendHjxbFreeGame) gameStateConfig.getGameStateConfigExtend();
        this.roundConfigExtend = (RoundNormalGameConfigExtendHjxbFreeGame) ((RoundConfigNormal)gameStateConfig.getRoundConfig()).getRoundNormalGameConfigExtend();
    }
    ...
    public GameStateHlrResult calculateGameStateHlrResult(int gameStateResultIndex, ConstMathSlot.ReelRtpType reelRtpType, SpinRequest spinRequest, GameStateHlrResult beforeGameStateHlrResult) {
        ...
        return new GameStateHlrResult(
                ...
                new GameStateHlrResultExtendHjxbBaseGame(),
    ...
    private RoundHlrResultExtend calculateRoundHlrResultExtend(GameCtrResult gameCtrResult, List<List<Integer>> multiplierMatrix) {
        ...
        // 3. 回傳
        return new RoundHlrResultExtendHjxbFreeGame(multiplierMatrix);
    }
