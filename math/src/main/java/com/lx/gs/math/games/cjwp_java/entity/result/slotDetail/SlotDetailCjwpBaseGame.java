package com.lx.gs.math.games.cjwp_java.entity.result.slotDetail;

import com.lx.gs.math.core.slot.slotDetailHlrMgr.enity.SlotDetail;

// 虎機詳細記錄超級王牌 基本遊戲
public class SlotDetailCjwpBaseGame extends SlotDetail {
    private final double spinCost; // 押注成本
    private final double baseGameTotalWin; // 總得分

    public SlotDetailCjwpBaseGame(double spinCost, double baseGameTotalWin) {
