package com.lx.gs.math.core.slot.progressHlrMgr.enity.input;
...
// 遊戲進度處理者 場次觸發局 總場次 輸入參數
public class ProgressHlrTotalInputTriggerRound extends AbstractProgressHlrTotalInput{
    ...
    public ProgressHlrTotalInputTriggerRound(int processIndex, GameStateHlrResult beforeGameStateHlrResult, List<RoundHlrResult> preRoundHlrResultList, SpecialFeatureHlrResultCluster currentSpecialFeatureHlrResultCluster) {
        super(processIndex);
