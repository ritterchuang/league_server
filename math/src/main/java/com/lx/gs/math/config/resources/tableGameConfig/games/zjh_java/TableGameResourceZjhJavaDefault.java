package com.lx.gs.math.config.resources.tableGameConfig.games.zjh_java;
...
import com.lx.gs.math.games.zjh_java.entity.ConstZjhJava;
import com.lx.gs.math.games.zjh_java.module.niu.NiuStackTmrConfigZjhJava;
...
// 新炸金花預設 牌桌遊戲設定
public class TableGameResourceZjhJavaDefault extends AbstractTableGameResourceCard {
    public TableGameConfigZjhJava create() {
        // 1. 計算遊戲調控設定
        ...
        // 8. 計算牛型轉換器設定
        NiuStackTmrConfigZjhJava niuStackTmrConfigQznnJava = new NiuStackTmrConfigZjhJava(
                new HashMap<>() {{
                    put(ConstNiu.NiuTypeEnumCommon.INVALID, ConstZjhJava.NiuTypeEnumZjhJava.INVALID);
                    put(ConstNiu.NiuTypeEnumCommon.NIU_0, ConstZjhJava.NiuTypeEnumZjhJava.NIU_0);
                    put(ConstNiu.NiuTypeEnumCommon.NIU_1, ConstZjhJava.NiuTypeEnumZjhJava.NIU_1);
                    put(ConstNiu.NiuTypeEnumCommon.NIU_2, ConstZjhJava.NiuTypeEnumZjhJava.NIU_2);
                    put(ConstNiu.NiuTypeEnumCommon.NIU_3, ConstZjhJava.NiuTypeEnumZjhJava.NIU_3);
                    put(ConstNiu.NiuTypeEnumCommon.NIU_4, ConstZjhJava.NiuTypeEnumZjhJava.NIU_4);
                    put(ConstNiu.NiuTypeEnumCommon.NIU_5, ConstZjhJava.NiuTypeEnumZjhJava.NIU_5);
                    put(ConstNiu.NiuTypeEnumCommon.NIU_6, ConstZjhJava.NiuTypeEnumZjhJava.NIU_6);
                    put(ConstNiu.NiuTypeEnumCommon.NIU_7, ConstZjhJava.NiuTypeEnumZjhJava.NIU_7);
                    put(ConstNiu.NiuTypeEnumCommon.NIU_8, ConstZjhJava.NiuTypeEnumZjhJava.NIU_8);
                    put(ConstNiu.NiuTypeEnumCommon.NIU_9, ConstZjhJava.NiuTypeEnumZjhJava.NIU_9);
                    put(ConstNiu.NiuTypeEnumCommon.NIU_NIU, ConstZjhJava.NiuTypeEnumZjhJava.NIU_NIU);
                    put(ConstNiu.NiuTypeEnumCommon.FLOWER_4, ConstZjhJava.NiuTypeEnumZjhJava.FLOWER_4);
                    put(ConstNiu.NiuTypeEnumCommon.FLOWER_5, ConstZjhJava.NiuTypeEnumZjhJava.FLOWER_5);
                    put(ConstNiu.NiuTypeEnumCommon.BOMB, ConstZjhJava.NiuTypeEnumZjhJava.BOMB);
                    put(ConstNiu.NiuTypeEnumCommon.SMALL_NIU, ConstZjhJava.NiuTypeEnumZjhJava.SMALL_NIU);
                }}
        );
        ...
        return new TableGameConfigZjhJava(
                gameAdjustConfig,
                rngAlgorithmConfig,
