package com.lx.gs.math.games.olldbz_java.module.gameStateHlr;
...
import com.lx.gs.math.core.slot.mathSlotConfigHlr.enity.sever.roundConfig.roundNormalGameConfig.RoundNormalGameConfigExtendOlldbzBaseGame;
...
import com.lx.gs.math.games.olldbz_java.entity.config.GameStateConfigExtendOlldbzBaseGame;
import com.lx.gs.math.games.olldbz_java.entity.result.gameStateResult.GameStateHlrResultExtendOlldbzBaseGame;
import com.lx.utils.MathUtil;

import java.util.ArrayList;

// 歐賴利的寶藏虎機 基本遊戲處理者
public class GameStateHlrOlldbzBaseGame extends AbstractGameStateHlr implements IGameStateHlr {
    private final LogicSlotNormal logic; // 牌桌邏輯
    private final GameStateConfigExtendOlldbzBaseGame gameStateConfigExtend; // 遊戲狀態額外設定
    private final RoundNormalGameConfigExtendOlldbzBaseGame roundConfigExtend; // 遊戲場次額外設定

    public GameStateHlrOlldbzBaseGame(int conditionId, int gameStateId, ITableUtilSlot tableUtil, ILogicSlot logic, GameStateConfig gameStateConfig) {
        super(conditionId, gameStateId, gameStateConfig, tableUtil);
        this.logic = (LogicSlotNormal) logic;
        this.gameStateConfigExtend = (GameStateConfigExtendOlldbzBaseGame) gameStateConfig.getGameStateConfigExtend();
        this.roundConfigExtend = (RoundNormalGameConfigExtendOlldbzBaseGame) ((RoundConfigNormal)gameStateConfig.getRoundConfig()).getRoundNormalGameConfigExtend();
    }
