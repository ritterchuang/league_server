...
// 新看四張搶莊牛牛遊戲桌
public class TableQznnK4zJavaWpr implements ISeverTableMessageCard {
    private final TableQznnK4zJava table; // 遊戲桌

    public TableQznnK4zJavaWpr(TableQznnK4zJava table) {
        this.table = table;
    }
