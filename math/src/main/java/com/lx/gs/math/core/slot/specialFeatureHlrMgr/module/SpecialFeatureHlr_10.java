...
// 消除類連續消除5次
public class SpecialFeatureHlr_10 extends AbstractSpecialFeatureHlr implements ISpecialFeatureHlr{
    private final int targetNumber = 5; // 目標消除數量
    private final SpecialFeatureHlrConfig config; // 設定檔
    private final ITableUtil tableUtil; // 牌桌工具包

    public SpecialFeatureHlr_10(SpecialFeatureHlrConfig specialFeatureHlrConfig, ITableUtil tableUtil) {
