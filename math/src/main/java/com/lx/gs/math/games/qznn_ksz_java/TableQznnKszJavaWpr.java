...
// 新看三張搶莊牛牛遊戲桌封裝器
public class TableQznnKszJavaWpr implements ISeverTableMessageCard {
    private final TableQznnKszJava table; // 新看三張搶莊牛牛遊戲桌

    public TableQznnKszJavaWpr(TableQznnKszJava table) {
        this.table = table;
    }
