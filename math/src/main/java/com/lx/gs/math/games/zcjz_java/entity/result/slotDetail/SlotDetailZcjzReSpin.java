package com.lx.gs.math.games.zcjz_java.entity.result.slotDetail;

import com.lx.gs.math.core.slot.slotDetailHlrMgr.enity.SlotDetail;

// 虎機詳細記錄父類別
public class SlotDetailZcjzReSpin extends SlotDetail {
    ...
    public SlotDetailZcjzReSpin(String reSpinScreenColumn_1, String reSpinScreenColumn_2, String reSpinScreenColumn_3, double reSpinTotalWin) {
