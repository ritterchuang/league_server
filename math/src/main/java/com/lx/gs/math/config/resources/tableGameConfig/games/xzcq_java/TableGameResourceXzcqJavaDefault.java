package com.lx.gs.math.config.resources.tableGameConfig.games.xzcq_java;
...
import com.lx.gs.math.core.slot.mathSlotConfigHlr.enity.sever.roundConfig.roundNormalGameConfig.RoundNormalGameConfigExtendXzcqBaseGame;
...
// 小豬傳奇老虎機牌桌遊戲設定產生器
public class TableGameResourceXzcqJavaDefault extends AbstractTableGameResourceSlot {
    ...
    public TableGameConfigSlot create() {
        ...
        FiniteAwardPoolConfigExtendBaseReSpin highHEReel = new FiniteAwardPoolConfigExtendBaseReSpin(
                new ArrayList<>() {
                    {
                        add(new OddsBox(0, 592698));
                        add(new OddsBox(2, 214590));
                        add(new OddsBox(5, 43320));
                        add(new OddsBox(10, 14200));
                        add(new OddsBox(25, 5000));
                        add(new OddsBox(50, 900));
                    }
                }, // 倍數資訊列表
                0, // 空白標誌 damp 列表
                new ArrayList<>() {
        ...
        // 8. 設定遊戲狀態設定
        GameStateConfig xzcqBaseGameStateConfig = new GameStateConfig(
                ConstMathSlot.GameStateType.XZCQ_BASEGAME,
                new GameStateConfigExtendXzcqBaseGame(
                ...
                new RoundConfigNormal(
                        ...
                        ConstMathSlot.RoundNormalGameType.XZCQ_BASEGAME,
                        new RoundNormalGameConfigExtendXzcqBaseGame()
                ),
                ConstMathSlot.SlotDetailType.XZCQ_BASEGAME);
                ...
                new HashMap<>() {
                    {
                        ...
                        put(ConstMathSlot.OddsWinType.MEGA_WIN, 25);
                        put(ConstMathSlot.OddsWinType.ULTRA_WIN, 50);
                    }
                }
        ));
