package com.lx.gs.math.games.pxky_java.enity.result.slotDetail;

import com.lx.gs.math.core.slot.slotDetailHlrMgr.enity.SlotDetail;

// 虎機詳細記錄父類別
public class SlotDetailPxkyBaseGame extends SlotDetail {
    ...
    public SlotDetailPxkyBaseGame(double spinCost, String screenColumn_1, String screenColumn_2, String screenColumn_3, double baseGameTotalWin) {
