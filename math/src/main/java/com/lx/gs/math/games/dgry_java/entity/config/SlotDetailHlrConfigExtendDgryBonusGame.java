package com.lx.gs.math.games.dgry_java.entity.config;
...
// 虎機詳細記錄計算者額外設定 帝国榮耀額外遊戲
public class SlotDetailHlrConfigExtendDgryBonusGame extends SlotDetailHlrConfigExtend {
    private final SymbolConfig symbolConfig; // 標誌設定

    public SlotDetailHlrConfigExtendDgryBonusGame(Map<Integer, String> symbolIdToStringMap, FrameConfig frameConfig, ReelConfig reelConfig, SymbolConfig symbolConfig) {
