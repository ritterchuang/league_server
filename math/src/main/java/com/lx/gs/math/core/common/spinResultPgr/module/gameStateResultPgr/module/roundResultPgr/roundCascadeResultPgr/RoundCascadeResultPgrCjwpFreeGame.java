...
// 客製局結果包裝者消除 超級王牌免費遊戲
public class RoundCascadeResultPgrCjwpFreeGame implements IRoundResultPgr {
    ...
    public RoundCascadeResultPgrCjwpFreeGame(ClientRoundResultPgrConfig config, ITableUtil tableUtil) {
