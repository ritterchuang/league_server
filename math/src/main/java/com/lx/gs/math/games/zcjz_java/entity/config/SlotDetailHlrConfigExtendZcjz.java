package com.lx.gs.math.games.zcjz_java.entity.config;
...
// 虎機詳細記錄計算者額外設定招財金豬
public class SlotDetailHlrConfigExtendZcjz extends SlotDetailHlrConfigExtend {
    private final SymbolConfig symbolConfig; // 標誌設定

    public SlotDetailHlrConfigExtendZcjz(Map<Integer, String> symbolIdToStringMap, FrameConfig frameConfig, ReelConfig reelConfig, SymbolConfig symbolConfig) {
