...
// 客製局結果包裝者消除 開發虎機
public class RoundCascadeResultPgrDevHj implements IRoundResultPgr {
    ...
    public RoundCascadeResultPgrDevHj(ClientRoundResultPgrConfig config, ITableUtil tableUtil) {
