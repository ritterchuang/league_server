...
import org.lsj.gs.math.core.slot.readyHandHlrMgr.enity.result.readyHandHlrExtendResult.ReadyHandHlrExtendResultReadyHand06;
...
// 聽牌處理者 06
// 畫面第1、2、3、4軸出現 BonusGame_01後，第5輪放慢，前面的輪軸有出現的標誌閃爍
public class ReadyHandHlr_06 extends AbstractReadyHandHlr implements IReadyHandHlr{
    ...
    public ReadyHandHlr_06(ReadyHandHlrConfig config, ITableUtil tableUtil) {
    ...
    private ReadyHandHlrResult calculateReadyHandHlrResultPerColumn(List<List<Integer>> screenSymbol, int currentColumnIndex) {
        ...
        return new ReadyHandHlrResult(
                ...
                new ReadyHandHlrExtendResultReadyHand06(
