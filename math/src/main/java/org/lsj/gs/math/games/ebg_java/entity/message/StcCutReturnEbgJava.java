...
// 斷線重連訊息
public class StcCutReturnEbgJava extends AbstractStcMessageEbgJava {
    // 共用參數
    ...
    public StcCutReturnEbgJava(int stage,
                               int leftTime,
                               int[] opRates,
                               int banker,
                               int bankerRate,
                               ...
                               int[] types,
                               double[] scores) {
        super(StcCutReturnEbgJava.class.getCanonicalName());
        this.stage = stage;
