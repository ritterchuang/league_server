...
// 客製局結果包裝者一般 黃金西部基礎遊戲
public class RoundResultNormalPgrHjxbBaseGame extends AbstractRoundResultNormalPgr {

    public RoundResultNormalPgrHjxbBaseGame(ClientRoundResultPgrConfig config, ITableUtil tableUtil) {
