...
// 一般遊戲局額外設定黃金西部免費遊戲
public class RoundNormalGameConfigExtendHjxbFreeGame extends RoundNormalGameConfigExtend{
    ...
    public RoundNormalGameConfigExtendHjxbFreeGame(int targetSymbolId, List<List<Integer>> multiplierList, List<List<Integer>> weightList) {
