...
// 比牌訊息
public class StcCompareZjhJava extends AbstractStcMessageZjhJava {
    ...
    public StcCompareZjhJava(int[][] cards, int[][] lifts, int[] types, double[] scores){
        super(StcCompareZjhJava.class.getCanonicalName());
        this.cards = cards;
        this.lifts = lifts;
        this.types = types;
        this.scores = scores;
