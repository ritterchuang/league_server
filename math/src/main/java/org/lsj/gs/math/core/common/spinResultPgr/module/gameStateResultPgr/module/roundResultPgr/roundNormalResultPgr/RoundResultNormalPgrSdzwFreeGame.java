...
// 客製局結果包裝者一般 聖誕任務免費遊戲
public class RoundResultNormalPgrSdzwFreeGame extends AbstractRoundResultNormalPgr {

    public RoundResultNormalPgrSdzwFreeGame(ClientRoundResultPgrConfig config, ITableUtil tableUtil) {
