package org.lsj.gs.math.config.resources.tableGameConfig.games.zcjz_java;
...
// 招財金豬老虎機牌桌遊戲設定產生器
public class TableGameResourceZcjzJavaDefault extends AbstractTableGameResourceSlot {
    ...
    public TableGameConfigSlot create() {
        ...
        // 8. 設定遊戲狀態設定
        GameStateConfig zcjzBaseGameStateConfig = new GameStateConfig(
                ConstMathSlot.GameStateType.ZCJZ_BASEGAME,
                new GameStateConfigExtendZcjzBaseGame(
                ...
                new RoundConfigNormal(
                        ...
                        new RoundNormalGameConfigExtendZcjzBaseGame()
                ),
                ConstMathSlot.SlotDetailType.ZCJZ_BASEGAME);
