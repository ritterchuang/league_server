package org.lsj.gs.math.games.sbxc_java.entity.result.roundResult;
...
// 客製遊戲局額外結果三倍小丑基礎遊戲
public class RoundHlrResultExtendSbxcBaseGame extends RoundHlrResultExtend {
    ...
    public RoundHlrResultExtendSbxcBaseGame(double totalWin, List<Integer> reSpinStrip, ScreenGtrResult screenGtrResult, GameCtrResult reSpinGameCtrResult) {
        super(totalWin);
