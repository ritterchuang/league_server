...
// 畫面中恰有5欄有 FreeGame_01
public class SpecialFeatureHlr_04 extends AbstractSpecialFeatureHlr implements ISpecialFeatureHlr{
    private final int targetNumber = 5; // 目標標誌個數
    private final SpecialFeatureHlrConfig config; // 設定檔
    private final ITableUtil tableUtil; // 牌桌工具包

    public SpecialFeatureHlr_04(SpecialFeatureHlrConfig specialFeatureHlrConfig, ITableUtil tableUtil) {
