package org.lsj.gs.math.config.resources.tableGameConfig.games.wl_java;
...
import org.lsj.gs.math.core.slot.mathSlotConfigHlr.enity.sever.roundConfig.roundNormalGameConfig.RoundNormalGameConfigExtendWlBaseGame;
import org.lsj.gs.math.core.slot.mathSlotConfigHlr.enity.sever.roundConfig.roundNormalGameConfig.RoundNormalGameConfigExtendWlFreeGame;
...
import org.lsj.gs.math.games.wl_java.enity.config.GameStateConfigExtendWlBaseGame;
import org.lsj.gs.math.games.wl_java.enity.config.GameStateConfigExtendWlFreeGame;
...
// 旺來老虎機牌桌遊戲設定產生器
public class TableGameResourceWlJavaDefault extends AbstractTableGameResourceSlot {
    ...
    public TableGameConfigSlot create() {
        ...
        // 7. 設定遊戲狀態設定
        GameStateConfig wlBaseGameStateConfig = new GameStateConfig(ConstMathSlot.GameStateType.WL_BASEGAME,
                new GameStateConfigExtendWlBaseGame(), new GameStateInputConfig(ConstMathSlot.GameStateInputType.NONE, new GameStateInputConfigExtendNone()), ConstMathSlot.RoundType.NORMAL,
                new RoundConfigNormal(
                        ...
                        )), ConstMathSlot.RoundNormalGameType.WL_BASEGAME, new RoundNormalGameConfigExtendWlBaseGame()
                ),
                ConstMathSlot.SlotDetailType.WL_BASEGAME
        );

        GameStateConfig wldbFreeGameStateConfig = new GameStateConfig(ConstMathSlot.GameStateType.WL_FREEGAME,
                new GameStateConfigExtendWlFreeGame(), new GameStateInputConfig(ConstMathSlot.GameStateInputType.NONE, new GameStateInputConfigExtendNone()), ConstMathSlot.RoundType.NORMAL,
                new RoundConfigNormal(
                        new ReelConfig(
                                ConstMathSlot.ReelType.REEL_DEPENDENT,
                                new ArrayList<>(){
                        ...
                        new RoundNormalGameConfigExtendWlFreeGame(
                                0,
                                List.of(
                                        List.of(0),
                                        List.of(2,3),
                ...
                ConstMathSlot.SlotDetailType.WL_FREEGAME
        );
        ...
        GameStateConfigCluster gameStateConfigCluster = new GameStateConfigCluster(
                ...
                new ArrayList<>(){
                    {
                        add(
                                wlBaseGameStateConfig
                        );
                        add(
                                wldbFreeGameStateConfig
                        );
                    }
                } // 遊戲狀態設定列表
        );
