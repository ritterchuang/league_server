...
// 客製局結果包裝者一般 大運奪寶基礎遊戲
public class RoundResultNormalPgrDydbBaseGame extends AbstractRoundResultNormalPgr {

    public RoundResultNormalPgrDydbBaseGame(ClientRoundResultPgrConfig config, ITableUtil tableUtil) {
