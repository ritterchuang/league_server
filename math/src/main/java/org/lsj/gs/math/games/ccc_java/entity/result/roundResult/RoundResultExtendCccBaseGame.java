package org.lsj.gs.math.games.ccc_java.entity.result.roundResult;
...
// 客端客製遊戲局額外結果777基礎遊戲
public class RoundResultExtendCccBaseGame extends RoundResultExtend {
    ...
    public RoundResultExtendCccBaseGame(double totalWin, List<Integer> reSpinStrip, int reSpinStopIndex, GameResult reSpinGameResult) {
        super(totalWin);
