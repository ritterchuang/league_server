...
import org.lsj.gs.math.core.fish.hitCtrMgr.module.hitCtr.robotResultWpr.robotResultCtr.enity.config.RobotResultCtrConfigExtendReel;
...
// 機器人結果計算者滾輪
public class RobotResultCtrReel extends AbstractRobotResultCtr implements IRobotResultCtr {
    private final ConstMathFish.HitType hitType; // 機器人結果打擊類型
    private final RobotResultCtrConfigExtendReel config; // 機器人結果打擊設定

    public RobotResultCtrReel(ConstMathFish.HitType hitType, RobotResultCtrConfigExtendReel robotResultCtrConfigExtendReel, double robotRtp) {
        super(robotRtp);
        this.hitType = hitType;
        this.config = robotResultCtrConfigExtendReel;
    }
