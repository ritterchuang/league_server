...
// 客製局結果包裝者一般 歐賴利的寶藏 基礎遊戲
public class RoundResultNormalPgrOlldbzBaseGame extends AbstractRoundResultNormalPgr {

    public RoundResultNormalPgrOlldbzBaseGame(ClientRoundResultPgrConfig config, ITableUtil tableUtil) {
