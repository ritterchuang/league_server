...
// 斷線重連訊息
public class StcCutReturnQznnKszJava extends AbstractStcMessageQznnKszJava {
    // 共用參數
    ...
    public StcCutReturnQznnKszJava(int stage,
                                   int leftTime,
                                   int[] rates,
                                   int banker,
                                   int bankerRate,
                                   ...
                                   int[] types,
                                   double[] scores) {
        super(StcCutReturnQznnKszJava.class.getCanonicalName());
        this.stage = stage;
