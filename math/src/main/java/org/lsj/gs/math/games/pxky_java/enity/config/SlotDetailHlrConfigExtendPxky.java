package org.lsj.gs.math.games.pxky_java.enity.config;
...
// 虎機詳細記錄計算者額外設定貔貅開運
public class SlotDetailHlrConfigExtendPxky extends SlotDetailHlrConfigExtend {
    private final SymbolConfig symbolConfig; // 標誌設定

    public SlotDetailHlrConfigExtendPxky(Map<Integer, String> symbolIdToStringMap, FrameConfig frameConfig, ReelConfig reelConfig, SymbolConfig symbolConfig) {
