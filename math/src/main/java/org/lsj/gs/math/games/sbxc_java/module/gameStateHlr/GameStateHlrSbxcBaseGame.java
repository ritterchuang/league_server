package org.lsj.gs.math.games.sbxc_java.module.gameStateHlr;
...
import org.lsj.gs.math.core.slot.mathSlotConfigHlr.enity.sever.roundConfig.roundNormalGameConfig.RoundNormalGameConfigExtendSbxcBaseGame;
...
import org.lsj.gs.math.games.sbxc_java.entity.result.gameStateResult.GameStateHlrResultExtendSbxcBaseGame;
...
// 三倍小丑基礎遊戲處理者
public class GameStateHlrSbxcBaseGame extends AbstractGameStateHlr implements IGameStateHlr {
    private final LogicSlotNormal logic; // 牌桌邏輯
    private final GameStateConfigExtendSbxcBaseGame gameStateConfigExtend; // 遊戲狀態額外設定
    private final RoundNormalGameConfigExtendSbxcBaseGame roundConfigExtend; // 遊戲場次額外設定
    private final IFiniteAwardPoolHlr finiteAwardPoolHlr; // 有限獎項處理者

    public GameStateHlrSbxcBaseGame(int conditionId, int gameStateId, ITableUtilSlot tableUtil, ILogicSlot logic, IFiniteAwardPoolHlr finiteAwardPoolHlr, GameStateConfig gameStateConfig) {
        super(conditionId, gameStateId, gameStateConfig, tableUtil);
        this.logic = (LogicSlotNormal)logic;
        this.gameStateConfigExtend = (GameStateConfigExtendSbxcBaseGame) gameStateConfig.getGameStateConfigExtend();
        this.roundConfigExtend = (RoundNormalGameConfigExtendSbxcBaseGame) ((RoundConfigNormal)gameStateConfig.getRoundConfig()).getRoundNormalGameConfigExtend();
    ...
    public GameStateHlrResult calculateGameStateHlrResult(int gameStateResultIndex, ConstMathSlot.ReelRtpType reelRtpType, SpinRequest spinRequest, GameStateHlrResult beforeGameStateHlrResult) {
        ...
        return new GameStateHlrResult(
                ...
                new GameStateHlrResultExtendSbxcBaseGame(),
    ...
    private RoundHlrResultExtend calculateRoundHlrResultExtend(int conditionId, List<DampScreenBox> dampScreenBoxList) {
       ...
       List<Integer> reSpinReelStrip = this.getReSpinReelStrip(reSpinScreenGtrResult.getReelCtrResult().getReelId());
        ...
        // 5. 回傳
        return new RoundHlrResultExtendSbxcBaseGame(
