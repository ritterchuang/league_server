...
// 客製局結果包裝者一般 死亡之書基礎遊戲
public class RoundResultNormalPgrSwzsBaseGame extends AbstractRoundResultNormalPgr {

    public RoundResultNormalPgrSwzsBaseGame(ClientRoundResultPgrConfig config, ITableUtil tableUtil) {
