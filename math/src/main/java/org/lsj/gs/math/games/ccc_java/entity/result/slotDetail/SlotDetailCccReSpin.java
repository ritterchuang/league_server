...
// 虎機詳細記錄父類別
public class SlotDetailCccReSpin extends SlotDetail {
    ...
    public SlotDetailCccReSpin(String reSpinScreenColumn_1, String reSpinScreenColumn_2, String reSpinScreenColumn_3, double reSpinTotalWin) {
