package org.lsj.gs.math.games._develop_hj_java.module.gameStateHlr;
...
// 開發虎機 基本遊戲處理者 TODO
public class GameStateHlrDevelopHjBaseGame extends AbstractGameStateHlr implements IGameStateHlr {
    private final LogicSlotCascade logic; // 牌桌邏輯

    public GameStateHlrDevelopHjBaseGame(int conditionId, int gameStateId, ITableUtilSlot tableUtil, ILogicSlot logic, GameStateConfig gameStateConfig) {
