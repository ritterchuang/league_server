...
// 客製局結果包裝者一般 死亡之書免費遊戲
public class RoundResultNormalPgrSwzsFreeGame extends AbstractRoundResultNormalPgr {

    public RoundResultNormalPgrSwzsFreeGame(ClientRoundResultPgrConfig config, ITableUtil tableUtil) {
