...
// 比牌訊息
public class StcCompareQznnKszJava extends AbstractStcMessageQznnKszJava {
    ...
    public StcCompareQznnKszJava(int[][] cards, int[][] lifts, int[] types, double[] scores){
        super(StcCompareQznnKszJava.class.getCanonicalName());
        this.cards = cards;
        this.lifts = lifts;
        this.types = types;
        this.scores = scores;
