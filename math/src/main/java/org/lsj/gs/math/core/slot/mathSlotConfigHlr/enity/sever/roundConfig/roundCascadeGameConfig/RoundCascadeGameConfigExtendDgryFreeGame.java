...
// 消除遊戲局額外設定 帝国榮耀 免費遊戲
public class RoundCascadeGameConfigExtendDgryFreeGame extends RoundCascadeGameConfigExtend{
    private final int minTargetSymbolCount; // 觸發免費遊戲，至少要幾個SC
    private final int addRound; // 每多一個 SC，增加幾場免費遊戲

    public RoundCascadeGameConfigExtendDgryFreeGame(int minTargetSymbolCount, int addRound) {
