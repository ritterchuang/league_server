...
// 搶莊結果訊息
public class StcVieResultQznnK4zJava extends AbstractStcMessageQznnK4zJava {
    @JsonIgnore public int banker; // 莊家位置
    @JsonIgnore public int bankerRate; // 莊家倍數
    @JsonIgnore public int[] viers; // 競爭莊家位置

    public StcVieResultQznnK4zJava(int banker, int bankerRate, int[] viers) {
        super(StcVieResultQznnK4zJava.class.getCanonicalName());
        this.banker = banker;
