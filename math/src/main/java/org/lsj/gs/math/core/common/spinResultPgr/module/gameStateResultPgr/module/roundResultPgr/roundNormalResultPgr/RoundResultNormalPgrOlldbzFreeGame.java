...
// 客製局結果包裝者一般 歐賴利的寶藏 免費遊戲
public class RoundResultNormalPgrOlldbzFreeGame extends AbstractRoundResultNormalPgr {

    public RoundResultNormalPgrOlldbzFreeGame(ClientRoundResultPgrConfig config, ITableUtil tableUtil) {
