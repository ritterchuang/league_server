...
// 搶莊結果訊息
public class StcVieResultQznnJava extends AbstractStcMessageQznnJava {
    @JsonIgnore public int banker; // 莊家位置
    @JsonIgnore public int bankerRate; // 莊家倍數
    @JsonIgnore public int[] viers; // 競爭莊家位置

    public StcVieResultQznnJava(int banker, int bankerRate, int[] viers) {
        super(StcVieResultQznnJava.class.getCanonicalName());
        this.banker = banker;
