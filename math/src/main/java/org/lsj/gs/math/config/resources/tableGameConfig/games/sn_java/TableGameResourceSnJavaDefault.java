package org.lsj.gs.math.config.resources.tableGameConfig.games.sn_java;
...
import org.lsj.gs.math.core.slot.mathSlotConfigHlr.enity.sever.roundConfig.roundNormalGameConfig.RoundNormalGameConfigExtendSnBaseGame;
import org.lsj.gs.math.core.slot.mathSlotConfigHlr.enity.sever.roundConfig.roundNormalGameConfig.RoundNormalGameConfigExtendSnFreeGame;
...
import org.lsj.gs.math.games.sn_java.entity.config.GameStateConfigExtendSnBaseGame;
import org.lsj.gs.math.games.sn_java.entity.config.GameStateConfigExtendSnFreeGame;
...
// 水牛老虎機牌桌遊戲設定產生器
public class TableGameResourceSnJavaDefault extends AbstractTableGameResourceSlot {
    ...
    public TableGameConfigSlot create() {
        ...
        // 7. 設定遊戲狀態設定
        GameStateConfig snBaseGameStateConfig = new GameStateConfig(
                ConstMathSlot.GameStateType.SN_BASEGAME, new GameStateConfigExtendSnBaseGame(), new GameStateInputConfig(ConstMathSlot.GameStateInputType.NONE, new GameStateInputConfigExtendNone()), ConstMathSlot.RoundType.NORMAL, new RoundConfigNormal(
                new ReelConfig(
                ...
                new PayTableConfig(new ArrayList<>() {
                ...
                }), new ProgressConfig(ConstMathSlot.ProgressType.ROUND, new ProgressConfigExtendRound(1, 0, 1)), new SpecialFeatureConfigCluster(new ArrayList<>() {
                    {
                        ...
                        new RoundNormalGameConfigExtendSnBaseGame()

        ), ConstMathSlot.SlotDetailType.SN_BASEGAME
        );
        GameStateConfig snFreeGameStateConfig = new GameStateConfig(
                ConstMathSlot.GameStateType.SN_FREEGAME, new GameStateConfigExtendSnFreeGame(), new GameStateInputConfig(ConstMathSlot.GameStateInputType.NONE, new GameStateInputConfigExtendNone()), ConstMathSlot.RoundType.NORMAL, new RoundConfigNormal(
                        new ReelConfig(
                                ConstMathSlot.ReelType.REEL_DEPENDENT,
                                new ArrayList<>(){
                                    {
                ...
                new PayTableConfig(new ArrayList<>(){
                    {
                        ...
                        new RoundNormalGameConfigExtendSnFreeGame(
                                0,
                                List.of(
                                        List.of(0),
                                        List.of(2,3),
        ...
        ), ConstMathSlot.SlotDetailType.SN_FREEGAME
        );
        ...
        GameStateConfigCluster gameStateConfigCluster = new GameStateConfigCluster(
                ...
                new ArrayList<>(){
                    {
                        add(
                                snBaseGameStateConfig
                        );
                        add(
                                snFreeGameStateConfig
                        );
                    }
                } // 遊戲狀態設定列表
        );
