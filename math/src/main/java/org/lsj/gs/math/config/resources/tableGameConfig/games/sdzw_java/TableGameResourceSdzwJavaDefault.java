package org.lsj.gs.math.config.resources.tableGameConfig.games.sdzw_java;
...
import org.lsj.gs.math.core.slot.mathSlotConfigHlr.enity.sever.roundConfig.roundNormalGameConfig.RoundNormalGameConfigExtendSdzwBaseGame;
import org.lsj.gs.math.core.slot.mathSlotConfigHlr.enity.sever.roundConfig.roundNormalGameConfig.RoundNormalGameConfigExtendSdzwFreeGame;
...
import org.lsj.gs.math.games.sdzw_java.enity.config.GameStateConfigExtendSdzwBaseGame;
import org.lsj.gs.math.games.sdzw_java.enity.config.GameStateConfigExtendSdzwFreeGame;
...
// 聖誕任務老虎機牌桌遊戲設定產生器
public class TableGameResourceSdzwJavaDefault extends AbstractTableGameResourceSlot {
    ...
    public TableGameConfigSlot create() {
        ...
        // 7. 設定遊戲狀態設定
        GameStateConfig sdzwBaseGameStateConfig = new GameStateConfig(ConstMathSlot.GameStateType.SDZW_BASEGAME,
                new GameStateConfigExtendSdzwBaseGame(), new GameStateInputConfig(ConstMathSlot.GameStateInputType.NONE, new GameStateInputConfigExtendNone()), ConstMathSlot.RoundType.NORMAL,
                new RoundConfigNormal(
                        ...
                        )), ConstMathSlot.RoundNormalGameType.SDZW_BASEGAME, new RoundNormalGameConfigExtendSdzwBaseGame()
                ),
                ConstMathSlot.SlotDetailType.SDZW_BASEGAME
        );

        GameStateConfig sdzwFreeGameStateConfig = new GameStateConfig(ConstMathSlot.GameStateType.SDZW_FREEGAME,
                new GameStateConfigExtendSdzwFreeGame(), new GameStateInputConfig(ConstMathSlot.GameStateInputType.NONE, new GameStateInputConfigExtendNone()), ConstMathSlot.RoundType.NORMAL,
                new RoundConfigNormal(
                        new ReelConfig(
                                ConstMathSlot.ReelType.REEL_DEPENDENT,
                                new ArrayList<>(){
                        ...
                        new PayTableConfig(new ArrayList<>(){
                            {
                                ...
                                )), ConstMathSlot.RoundNormalGameType.SDZW_FREEGAME, new RoundNormalGameConfigExtendSdzwFreeGame()
                ),
                ConstMathSlot.SlotDetailType.SDZW_FREEGAME
        );
        ...
        GameStateConfigCluster gameStateConfigCluster = new GameStateConfigCluster(
                ...
                new ArrayList<>(){
                    {
                        add(
                                sdzwBaseGameStateConfig
                        );
                        add(
                                sdzwFreeGameStateConfig
                        );
                    }
                } // 遊戲狀態設定列表
        );
