package org.lsj.gs.math.games.lucky777.module.gameStateHlr;
...
import org.lsj.gs.math.games.lucky777.enity.result.gameStateResult.GameStateHlrResultExtendLucky777BaseGame;
import org.lsj.utils.MathUtil;

import java.util.ArrayList;

// Lucky777 基礎遊戲處理者
public class GameStateHlrLucky777BaseGame extends AbstractGameStateHlr implements IGameStateHlr {
    private final LogicSlotNormal logic; // 牌桌邏輯
    private final GameStateConfigExtendLucky777BaseGame gameStateConfigExtend; // 遊戲狀態額外設定
    private final RoundNormalGameConfigExtendLucky777BaseGame roundConfigExtend; // 遊戲場次額外設定

    public GameStateHlrLucky777BaseGame(int conditionId, int gameStateId, ITableUtilSlot tableUtil, ILogicSlot logic, GameStateConfig gameStateConfig) {
        super(conditionId, gameStateId, gameStateConfig, tableUtil);
        this.logic = (LogicSlotNormal) logic;
        this.gameStateConfigExtend = (GameStateConfigExtendLucky777BaseGame) gameStateConfig.getGameStateConfigExtend();
        this.roundConfigExtend = (RoundNormalGameConfigExtendLucky777BaseGame) ((RoundConfigNormal)gameStateConfig.getRoundConfig()).getRoundNormalGameConfigExtend();
    }
    ...
    public GameStateHlrResult calculateGameStateHlrResult(int gameStateResultIndex, ConstMathSlot.ReelRtpType reelRtpType, SpinRequest spinRequest, GameStateHlrResult beforeGameStateHlrResult) {
        ...
        return new GameStateHlrResult(
                ...
                new GameStateHlrResultExtendLucky777BaseGame(),
