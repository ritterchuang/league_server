...
// 玩家選牌訊息
public class StcSelectQznnK4zJava extends AbstractStcMessageQznnK4zJava {
    ...
    public StcSelectQznnK4zJava(int chair,
                                int[] cards,
                                int[] lifts,
                                int type){
        super(StcSelectQznnK4zJava.class.getCanonicalName());
        this.chair = chair;
        this.cards = cards;
        this.lifts = lifts;
        this.type = type;
