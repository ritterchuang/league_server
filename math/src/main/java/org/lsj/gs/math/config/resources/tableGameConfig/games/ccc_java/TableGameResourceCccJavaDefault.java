package org.lsj.gs.math.config.resources.tableGameConfig.games.ccc_java;
...
import org.lsj.gs.math.core.slot.mathSlotConfigHlr.enity.sever.roundConfig.roundNormalGameConfig.RoundNormalGameConfigExtendCccBaseGame;
...
// 777老虎機牌桌遊戲設定產生器
public class TableGameResourceCccJavaDefault extends AbstractTableGameResourceSlot {
    ...
    public TableGameConfigSlot create() {
                ...
                new ArrayList<>() {
                    {
                        ...
                        add(new OddsBox(2, 540410));
                        add(new OddsBox(6, 30740));
                        add(new OddsBox(10, 14636));
                        add(new OddsBox(20, 6084));
                        add(new OddsBox(40, 1384));
                        add(new OddsBox(100, 464));
                    }
                }, // 倍數資訊列表
                0, // 空白標誌 damp 列表
                new ArrayList<>() {
        ...
        // 8. 設定遊戲狀態設定
        GameStateConfig cccBaseGameStateConfig = new GameStateConfig(
                ConstMathSlot.GameStateType.CCC_BASEGAME,
                new GameStateConfigExtendCccBaseGame(
                ...
                new RoundConfigNormal(
                        ...
                        ConstMathSlot.RoundNormalGameType.CCC_BASEGAME,
                        new RoundNormalGameConfigExtendCccBaseGame()
                ),
                ConstMathSlot.SlotDetailType.CCC_BASEGAME);
                ...
                new HashMap<>() {
                    {
                        ...
                        put(ConstMathSlot.OddsWinType.MEGA_WIN, 40);
