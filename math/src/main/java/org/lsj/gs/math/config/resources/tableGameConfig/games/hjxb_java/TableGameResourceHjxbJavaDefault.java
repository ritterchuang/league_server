package org.lsj.gs.math.config.resources.tableGameConfig.games.hjxb_java;
...
import org.lsj.gs.math.core.slot.mathSlotConfigHlr.enity.sever.roundConfig.roundNormalGameConfig.RoundNormalGameConfigExtendHjxbBaseGame;
import org.lsj.gs.math.core.slot.mathSlotConfigHlr.enity.sever.roundConfig.roundNormalGameConfig.RoundNormalGameConfigExtendHjxbFreeGame;
...
import org.lsj.gs.math.games.hjxb_java.entity.config.GameStateConfigExtendHjxbBaseGame;
import org.lsj.gs.math.games.hjxb_java.entity.config.GameStateConfigExtendHjxbFreeGame;
...
// 黃金西部老虎機牌桌遊戲設定產生器
public class TableGameResourceHjxbJavaDefault extends AbstractTableGameResourceSlot {
    ...
    public TableGameConfigSlot create() {
        ...
        // 7. 設定遊戲狀態設定
        GameStateConfig hjxbBaseGameStateConfig = new GameStateConfig(
                ConstMathSlot.GameStateType.HJXB_BASEGAME, new GameStateConfigExtendHjxbBaseGame(), new GameStateInputConfig(ConstMathSlot.GameStateInputType.NONE, new GameStateInputConfigExtendNone()), ConstMathSlot.RoundType.NORMAL, new RoundConfigNormal(
                new ReelConfig(
                        ...
                        new ArrayList<>() {
                            {
                                add(new ReelStripBox(
                                        ...
                                        new ReelConfigExtendReelDependent(
                                                new ArrayList<>() {
                                                    {
                                                        add(List.of(2,2,2,9,10,2,2,9,10,4,7,9,1,3,11,9,1,10,6,4,9,10,1,11,9,10,4,11,10,10,5,7,9,10,3,7,9,10,1,7,9,10,4,8,9,10,3,1,8,9,5,6,6,9,3,6,10,11,5,9,10,3,11,9,4,1,3,5,7,8,3,6,9,7,3,4,6,9,10,5,7,10,9,5,9,7,8,5,5,7,9,8,2,10,10,7,2,10,7,2,7,5,8,9,9,7,4,11,11,5,5,9,11,4,10,9,4,7,10,5,4,11,11));
                                                        add(List.of(2,2,2,9,7,0,8,4,11,10,8,9,11,3,10,6,8,8,10,5,9,8,3,6,8,3,10,9,5,8,10,3,9,8,4,10,9,5,6,1,8,9,3,6,9,5,8,9,1,10,9,4,6,10,5,11,11,4,10,9,1,11,6,6,8,11,1,7,3,8,11,4,1,8,5,9,8,3,10,8,4,9,1,10,11,5,9,10,4,10,11,3,1,7,5,8,6,3,8,9,2,2,7,3,8,9,5,8,10,3,9,7,5,9,9,5,8,9,5,9,8,3,8,10,5,8,9,3,10,10,5,8,9,4,6,9));
                                                        add(List.of(6,7,8,2,2,2,11,8,2,2,11,9,10,5,8,6,7,1,8,11,11,1,8,7,3,6,8,8,10,11,4,7,10,1,4,6,8,9,0,6,7,10,1,6,9,5,8,6,4,1,11,9,5,11,8,4,4,11,1,8,9,5,7,6,3,10,6,8,1,7,6,5,8,7,3,6,8,5,7,6,4,8,7,5,6,8,3,7,6,5,8,7,4,3,6,8,9,7,6,3,8,8,6,7,7,3,7,6,5,6,6,9,3,7,9,5,10,8,3,7,9,8));
                                                        add(List.of(6,7,8,2,2,2,6,9,2,2,10,9,6,0,10,8,9,5,8,6,1,7,9,8,3,11,7,10,1,11,11,8,10,7,5,8,6,3,7,8,5,6,7,8,8,6,3,9,8,4,6,7,3,11,11,4,7,8,3,6,10,4,7,6,3,8,6,1,11,8,5,6,7,4,8,6,3,11,8,5,6,7,4,8,6,3,7,8,5,6,7,4,6,6,5,7,6,4,11,11,11));
                                                        add(List.of(2,2,2,6,9,2,2,8,11,11,1,6,7,8,9,6,5,7,4,6,9,8,7,10,4,7,9,3,7,10,5,7,10,1,8,9,3,1,11,5,7,3,9,7,4,10,11,8,7,8,4,4,7,1,8,10,6,8,10,4,9,11,3,9,10,5,11,9,3,9,10,10,7,11,11,3,10,9,5,10,9,3,5,6,6));
                                                    }
                                                }),
                                ...
                                add(new ReelStripBox(
                                        ...
                                        new ReelConfigExtendReelDependent(
                                                new ArrayList<>() {
                                                    {
                                                        add(List.of(2,2,2,6,7,4,3,8,7,2,2,2,8,9,1,7,8,3,5,9,8,5,1,10,9,4,9,5,5,4,11,6,5,1,10,3,8,7,4,9,8,3,7,11,4,9,9,5,10,6,4,9,8,3,6,10,5,9,8,3,10,9,5,8,11,11));
                                                        add(List.of(2,2,2,6,7,4,3,6,9,3,8,6,0,8,8,5,6,9,0,8,6,5,7,0,1,5,11,4,8,7,1,9,8,3,9,10,5,8,9,4,7,8,5,11,7,0,9,9,5,7,9,3,8,10,5,9,9,3,3,8,9,11));
                                                        add(List.of(2,2,2,6,7,4,4,6,8,0,10,6,4,8,9,3,10,9,0,4,10,5,8,0,11,5,7,4,10,8,5,11,9,10,7,5,8,10,8,5,9,11,8,3,9,10,8,3,9,10,8,3,9,8,4,10,7,11,4,7,7));
                                                        add(List.of(2,2,2,6,7,4,4,11,8,9,0,7,9,5,11,7,4,11,7,0,6,7,4,6,7,3,6,10,4,11,7,5,11,7,3,6,10,0,6,7,10,3,3,11,11,5,5,6,3,10,10,11,5,6,11));
                                                        add(List.of(2,2,2,6,7,4,4,11,7,10,3,9,10,4,9,6,5,9,11,4,9,8,5,5,8,8,4,9,11,8,5,5,11,4,8,10,3,6,8,5,7,10,3,6,8,9,3,6,8,8,5,7,10,8,3,7,8,4,10,9,10,3,10,8,11,11));
                                                    }
                                                }),
                ...
                new InitialScreenConfig(
                        new ClientReelResult(0, ConstPgrSlot.ClientReelStopType.STOP_BY_DEPENDENT_REEL_BOX, new ClientReelStopResultExtendStopByDependentReelBox(new ArrayList<>() {
                            {
                                add(new StopBox(4, 1));
                                add(new StopBox(40, 1));
                                add(new StopBox(43, 1));
                                add(new StopBox(15, 1));
                                add(new StopBox(4, 1));
                            }
                        })),
                ...
                new PayTableConfig(new ArrayList<>() {
                ...
                }), new ProgressConfig(ConstMathSlot.ProgressType.ROUND, new ProgressConfigExtendRound(1, 0, 1)), new SpecialFeatureConfigCluster(new ArrayList<>() {
                    {
                        ...
                        add(new SpecialFeatureConfig(ConstMathSlot.SpecialFeatureType.SF_03, ConstMathSlot.TriggerEvent.TRIGGER_02, 5));
                        add(new SpecialFeatureConfig(ConstMathSlot.SpecialFeatureType.SF_04, ConstMathSlot.TriggerEvent.TRIGGER_03, 10));
                    }
                ...
                new RoundNormalGameConfigExtendHjxbBaseGame()

        ), ConstMathSlot.SlotDetailType.HJXB_BASEGAME
        );
        GameStateConfig hjxbFreeGameStateConfig = new GameStateConfig(
                ConstMathSlot.GameStateType.HJXB_FREEGAME, new GameStateConfigExtendHjxbFreeGame(), new GameStateInputConfig(ConstMathSlot.GameStateInputType.NONE, new GameStateInputConfigExtendNone()), ConstMathSlot.RoundType.NORMAL, new RoundConfigNormal(
                        new ReelConfig(
                                ConstMathSlot.ReelType.REEL_DEPENDENT,
                                new ArrayList<>(){
                                    {
                                        add(new ReelStripBox(
                                                ...
                                                new ReelConfigExtendReelDependent(
                                                        new ArrayList<>(){
                                                            {
                                                                add(List.of(2,2,2,9,10,2,2,9,10,4,7,9,1,10,7,11,11,10,7,4,9,10,5,7,9,9,7,10,5,9,7,3,10,9,1,7,10,4,6,9,10,3,6,8,9,5,7,9,4,6,10,5,9,10,3,7,9,4,8,10,5,11,8,2,6,11,4,6,7,7,8,7,2,2,8,10,4,11,6,3,8,11,4,10,7,4,8,10,5,11,11,11));
                                                                add(List.of(2,2,2,6,7,8,4,11,11,5,6,8,3,10,6,4,11,11,5,9,8,8,6,8,3,10,9,5,8,10,10,9,8,4,11,11,5,6,1,10,9,3,6,9,4,10,6,1,9,10,4,6,9,3,10,7,4,11,10,3,8,10,4,8,6,3,11,9,0,4,10,8,5,9,2,2,8,3,10,8,4,9,3,10,0,8,3,11,11,4,10,5,7,7,6,0,8,9,5,8,6,3,10,9,7,2,8,3,10,9,5,8,10,3,9,7,5,0,6,9,3,8,10,5,7,8));
                                                                add(List.of(6,7,8,2,2,2,6,8,5,5,11,11,0,9,9,8,10,5,6,7,1,8,6,7,1,11,7,3,6,8,5,11,2,7,2,4,10,11,4,7,9,2,2,9,9,6,0,11,4,9,7,0,11,11,11,4,9,7,3,8,9,9,7,6,3,11,11,5,10,8,5,7,6,3,10,8,5,7,6,4,8,7,5,6,8,3,7,6,5,8,7,4,3,6,8,5,7,6,4,8,7,5,6,8,3,7,6,5,7,6,9,3,7,9,5,10,8,3,0,7,9,5,11,7));
                                                                add(List.of(6,7,8,5,5,5,6,9,9,9,10,9,2,8,8,8,9,5,8,6,1,7,9,3,11,11,0,7,10,1,6,8,4,10,0,5,8,6,3,11,4,9,8,5,6,7,4,11,6,3,9,8,4,6,7,3,11,6,4,7,9,3,11,10,4,7,6,3,8,6,4,11,0,11,5,9,7,4,8,6,3,7,8,5,6,7,4,9,5,0,7,9,9,6,6,6,9,7,4,9,6,5,7,2,9,9));
                                                                add(List.of(2,2,2,9,6,6,6,8,11,10,10,2,6,11,3,9,6,5,7,4,6,11,5,7,6,4,7,9,3,7,11,5,7,10,1,8,9,3,1,9,5,11,11,3,9,7,4,10,9,3,7,8,4,10,6,3,8,10,5,11,8,10,4,9,8,3,9,10,2,7,6,9,3,7,11,10,2,7,8,3,10,9,2,7,8,3,10,9));
                                                            }
                                                        }),
                                                ConstMathSlot.ReelRtpType.HIGH,
                                                ConstMathSlot.ReelStopType.STOP_BY_DEPENDENT_REEL_INDEX));
                                        add(new ReelStripBox(
                                                ...
                                                new ReelConfigExtendReelDependent(
                                                        new ArrayList<>(){
                                                            {
                                                                add(List.of(2,2,2,9,10,2,2,9,10,4,7,9,1,10,7,11,11,10,7,4,9,10,5,7,9,9,7,10,5,9,7,3,10,9,1,7,10,4,6,9,10,3,6,8,9,5,7,9,4,6,10,5,9,10,3,7,9,4,8,10,5,11,8,2,6,11,4,6,7,7,8,7,2,2,8,10,4,11,6,3,8,11,4,10,7,4,8,10,5,11,11,11));
                                                                add(List.of(2,2,2,6,7,8,4,11,11,5,6,8,0,10,6,4,11,11,5,9,8,8,6,8,3,10,9,5,8,10,10,9,8,4,11,11,5,6,1,10,9,3,6,9,4,10,6,1,9,10,4,6,9,3,10,7,4,11,10,3,8,10,4,8,6,3,11,9,0,4,10,8,5,9,2,2,8,3,10,8,4,9,3,10,0,8,3,11,11,4,10,5,7,7,6,0,8,9,5,8,6,3,10,9,7,2,8,3,10,9,5,8,10,3,9,7,5,0,6,9,3,8,10,5,7,8));
                                                                add(List.of(6,7,8,2,2,2,6,8,5,5,11,11,0,9,9,8,10,5,6,7,1,8,6,7,1,11,7,3,6,8,5,11,2,7,2,4,10,11,4,7,9,2,2,9,9,6,0,11,4,9,7,0,11,11,11,4,9,7,3,8,9,9,7,6,3,11,11,5,10,8,5,7,6,3,10,8,5,7,6,4,8,7,5,6,8,3,7,6,5,8,7,4,3,6,8,5,7,6,4,8,7,5,6,8,3,7,6,5,7,6,9,3,7,9,5,10,8,3,0,7,9,5,11,7));
                                                                add(List.of(6,7,8,5,5,5,6,9,9,9,10,9,2,8,8,8,9,5,8,6,1,7,9,3,11,11,0,7,10,1,6,8,4,10,0,5,8,6,3,11,4,9,8,5,6,7,4,11,6,3,9,8,4,6,7,3,11,6,4,7,9,3,11,10,4,7,6,3,8,6,4,11,0,11,5,9,7,4,8,6,3,7,8,5,6,7,4,9,5,0,7,9,9,6,6,6,9,7,4,9,6,5,7,2,9,9));
                                                                add(List.of(2,2,2,9,6,6,6,8,11,10,10,2,6,11,3,9,6,5,7,4,6,11,5,7,6,4,7,9,3,7,11,5,7,10,1,8,9,3,1,9,5,11,11,3,9,7,4,10,9,3,7,8,4,10,6,3,8,10,5,11,8,10,4,9,8,3,9,10,2,7,6,9,3,7,11,10,2,7,8,3,10,9,2,7,8,3,10,9));
                                                            }
                ...
                new InitialScreenConfig(
                        new ClientReelResult(0, ConstPgrSlot.ClientReelStopType.STOP_BY_DEPENDENT_REEL_BOX, new ClientReelStopResultExtendStopByDependentReelBox(new ArrayList<>(){
                            {
                                add(new StopBox(4, 1));
                                add(new StopBox(75, 1));
                                add(new StopBox(21, 1));
                                add(new StopBox(35, 1));
                                add(new StopBox(4, 1));
                            }
                        })),
                ...
                new PayTableConfig(new ArrayList<>(){
                    {
                        ...
                        new ProgressConfigExtendTriggerRound(
                        ...
                        )), new SpecialFeatureConfigCluster(new ArrayList<>(){
                            {
                                ...
                                add(new SpecialFeatureConfig(ConstMathSlot.SpecialFeatureType.SF_03, ConstMathSlot.TriggerEvent.RE_TRIGGER_03, 5));
                                add(new SpecialFeatureConfig(ConstMathSlot.SpecialFeatureType.SF_04, ConstMathSlot.TriggerEvent.RE_TRIGGER_04, 10));
                            }
                        }), new ReadyHandConfigCluster(List.of(
                        ...
                        new RoundNormalGameConfigExtendHjxbFreeGame(
                                0,
                                List.of(
                                        List.of(0),
                                        List.of(2,3),
        ...
        ), ConstMathSlot.SlotDetailType.HJXB_FREEGAME
        );
        ...
        GameStateConfigCluster gameStateConfigCluster = new GameStateConfigCluster(
                ...
                new ArrayList<>(){
                    {
                        add(
                                hjxbBaseGameStateConfig
                        );
                        add(
                                hjxbFreeGameStateConfig
                        );
                    }
                } // 遊戲狀態設定列表
        );
