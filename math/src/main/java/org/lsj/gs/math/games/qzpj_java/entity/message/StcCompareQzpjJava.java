...
// 比牌訊息
public class StcCompareQzpjJava extends AbstractStcMessageQzpjJava {
    ...
    public StcCompareQzpjJava(int[][] cards, int[] types, double[] scores){
        super(StcCompareQzpjJava.class.getCanonicalName());
        this.cards = cards;
        this.types = types;
        this.scores = scores;
