...
// 聽牌處理者額外結果 ReadyHand02
public class ReadyHandHlrExtendResultReadyHand03 extends ReadyHandHlrExtendResult{
    private final List<Integer> targetSymbolIdList; // 聽牌列表
    private final int columnIndex; // 聽牌輪軸

    public ReadyHandHlrExtendResultReadyHand03(List<Integer> targetSymbolIdList, int columnIndex) {
