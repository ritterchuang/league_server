...
// 一般遊戲局額外設定水牛免費遊戲
public class RoundNormalGameConfigExtendSnFreeGame extends RoundNormalGameConfigExtend{
    ...
    public RoundNormalGameConfigExtendSnFreeGame(int targetSymbolId, List<List<Integer>> multiplierList, List<List<Integer>> weightList) {
