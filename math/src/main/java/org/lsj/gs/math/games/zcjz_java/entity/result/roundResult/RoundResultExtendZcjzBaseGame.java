package org.lsj.gs.math.games.zcjz_java.entity.result.roundResult;
...
// 客端客製遊戲局額外結果招財金豬基礎遊戲
public class RoundResultExtendZcjzBaseGame extends RoundResultExtend {
    ...
    public RoundResultExtendZcjzBaseGame(double totalWin, List<Integer> reSpinStrip, int reSpinStopIndex, GameResult reSpinGameResult) {
        super(totalWin);
