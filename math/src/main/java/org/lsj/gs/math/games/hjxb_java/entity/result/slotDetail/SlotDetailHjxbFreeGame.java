package org.lsj.gs.math.games.hjxb_java.entity.result.slotDetail;

import org.lsj.gs.math.core.slot.slotDetailHlrMgr.enity.SlotDetail;

// 虎機詳細記錄黃金西部免費遊戲
public class SlotDetailHjxbFreeGame extends SlotDetail {
    ...
    public SlotDetailHjxbFreeGame(int roundIndex, int totalRound, double roundTotalWin, String screenColumn_1, String screenColumn_2, String screenColumn_3, String screenColumn_4, String screenColumn_5, String multiplier_2, String multiplier_3, String multiplier_4) {
