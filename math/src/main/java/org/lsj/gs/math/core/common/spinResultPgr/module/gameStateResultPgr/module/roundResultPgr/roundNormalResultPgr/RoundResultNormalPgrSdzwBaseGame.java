...
// 客製局結果包裝者一般 聖誕任務基礎遊戲
public class RoundResultNormalPgrSdzwBaseGame extends AbstractRoundResultNormalPgr {

    public RoundResultNormalPgrSdzwBaseGame(ClientRoundResultPgrConfig config, ITableUtil tableUtil) {
