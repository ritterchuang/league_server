...
// 客製局結果包裝者一般 寶石之星基礎遊戲
public class RoundResultNormalPgrBszxBaseGame extends AbstractRoundResultNormalPgr {

    public RoundResultNormalPgrBszxBaseGame(ClientRoundResultPgrConfig config, ITableUtil tableUtil) {
