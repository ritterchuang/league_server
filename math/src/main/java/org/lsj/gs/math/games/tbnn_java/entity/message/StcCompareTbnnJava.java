...
// 比牌訊息
public class StcCompareTbnnJava extends AbstractStcMessageTbnnJava {
    ...
    public StcCompareTbnnJava(int[][] cards, int[][] lifts, int[] types, double[] scores){
        super(StcCompareTbnnJava.class.getCanonicalName());
        this.cards = cards;
        this.lifts = lifts;
        this.types = types;
        this.scores = scores;
