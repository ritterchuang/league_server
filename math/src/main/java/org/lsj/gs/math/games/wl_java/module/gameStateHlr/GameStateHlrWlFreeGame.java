package org.lsj.gs.math.games.wl_java.module.gameStateHlr;
...
import org.lsj.gs.math.games.wl_java.enity.result.gameStateResult.GameStateHlrResultExtendWlFreeGame;
import org.lsj.gs.math.games.wl_java.enity.result.roundResult.RoundHlrResultExtendWlFreeGame;
...
// 旺來免費遊戲處理者
public class GameStateHlrWlFreeGame extends AbstractGameStateHlr implements IGameStateHlr {
    private final LogicSlotNormal logic; // 牌桌邏輯
    private final GameStateConfigExtendWlFreeGame gameStateConfigExtend; // 遊戲狀態額外設定
    private final RoundNormalGameConfigExtendWlFreeGame roundConfigExtend; // 遊戲場次額外設定

    public GameStateHlrWlFreeGame(int conditionId, int gameStateId, ITableUtilSlot tableUtil, ILogicSlot logic, GameStateConfig gameStateConfig) {
        super(conditionId, gameStateId, gameStateConfig, tableUtil);
        this.logic = (LogicSlotNormal) logic;
        this.gameStateConfigExtend = (GameStateConfigExtendWlFreeGame) gameStateConfig.getGameStateConfigExtend();
        this.roundConfigExtend = (RoundNormalGameConfigExtendWlFreeGame) ((RoundConfigNormal)gameStateConfig.getRoundConfig()).getRoundNormalGameConfigExtend();
    }
    ...
    public GameStateHlrResult calculateGameStateHlrResult(int gameStateResultIndex, ConstMathSlot.ReelRtpType reelRtpType, SpinRequest spinRequest, GameStateHlrResult beforeGameStateHlrResult) {
        ...
        return new GameStateHlrResult(
                ...
                new GameStateHlrResultExtendWlFreeGame(),
    ...
    private RoundHlrResultExtend calculateRoundHlrResultExtend(GameCtrResult gameCtrResult, List<List<Integer>> multiplierMatrix) {
        ...
        // 3. 回傳
        return new RoundHlrResultExtendWlFreeGame(multiplierMatrix);
    }
