...
// 玩家選牌訊息
public class StcSelectQznnKszJava extends AbstractStcMessageQznnKszJava {
    ...
    public StcSelectQznnKszJava(int chair,
                                int[] cards,
                                int[] lifts,
                                int type){
        super(StcSelectQznnKszJava.class.getCanonicalName());
        this.chair = chair;
        this.cards = cards;
        this.lifts = lifts;
        this.type = type;
