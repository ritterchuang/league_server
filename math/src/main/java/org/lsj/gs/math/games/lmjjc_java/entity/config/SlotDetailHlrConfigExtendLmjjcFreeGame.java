package org.lsj.gs.math.games.lmjjc_java.entity.config;
...
// 虎機詳細記錄計算者額外設定 羅馬競技場免費遊戲
public class SlotDetailHlrConfigExtendLmjjcFreeGame extends SlotDetailHlrConfigExtend {
    private final SymbolConfig symbolConfig; // 標誌設定

    public SlotDetailHlrConfigExtendLmjjcFreeGame(Map<Integer, String> symbolIdToStringMap, FrameConfig frameConfig, ReelConfig reelConfig, SymbolConfig symbolConfig) {
