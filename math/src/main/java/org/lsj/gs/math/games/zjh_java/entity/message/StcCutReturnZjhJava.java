...
// 斷線重連訊息
public class StcCutReturnZjhJava extends AbstractStcMessageZjhJava {
    // 共用參數
    ...
    public StcCutReturnZjhJava(int stage,
                               int leftTime,
                               int[] rates,
                               int banker,
                               int bankerRate,
                               ...
                               int[] types,
                               double[] scores) {
        super(StcCutReturnZjhJava.class.getCanonicalName());
        this.stage = stage;
