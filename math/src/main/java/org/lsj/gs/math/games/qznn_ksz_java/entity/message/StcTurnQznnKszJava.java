...
// 操作位置訊息
public class StcTurnQznnKszJava extends AbstractStcMessageQznnKszJava {
    ...
    public StcTurnQznnKszJava(int oper,
                              double time,
                              int maxRate,
                              int[] rates){
        super(StcTurnQznnKszJava.class.getCanonicalName());
        this.oper = oper;
        this.time = time;
