package org.lsj.gs.math.games.hjxb_java.entity.config;
...
// 虎機詳細記錄計算者額外設定黃金西部免費遊戲
public class SlotDetailHlrConfigExtendHjxbFreeGame extends SlotDetailHlrConfigExtend {
    private final SymbolConfig symbolConfig; // 標誌設定

    public SlotDetailHlrConfigExtendHjxbFreeGame(Map<Integer, String> symbolIdToStringMap, FrameConfig frameConfig, ReelConfig reelConfig, SymbolConfig symbolConfig) {
