package org.lsj.gs.math.games.sbxc_java.entity.config;
...
// 虎機詳細記錄計算者額外設定三倍小丑
public class SlotDetailHlrConfigExtendSbxc extends SlotDetailHlrConfigExtend {
    private final SymbolConfig symbolConfig; // 標誌設定

    public SlotDetailHlrConfigExtendSbxc(Map<Integer, String> symbolIdToStringMap, FrameConfig frameConfig, ReelConfig reelConfig, SymbolConfig symbolConfig) {
