...
import org.lsj.gs.math.core.slot.readyHandHlrMgr.enity.result.readyHandHlrExtendResult.ReadyHandHlrExtendResultReadyHand02;
...
// 聽牌處理者 02
// 畫面出現1顆 FreeGame_01 後，後面的輪軸放慢，前面的輪軸有出現的標誌閃爍
public class ReadyHandHlr_02 extends AbstractReadyHandHlr implements IReadyHandHlr{
    ...
    public ReadyHandHlr_02(ReadyHandHlrConfig config, ITableUtil tableUtil) {
    ...
    private ReadyHandHlrResult calculateReadyHandHlrResultPerColumn(List<List<Integer>> screenSymbol, int targetColumnIndex) {
        ...
        return new ReadyHandHlrResult(
                ...
                new ReadyHandHlrExtendResultReadyHand02(
