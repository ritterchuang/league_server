...
import org.lsj.gs.math.games.dydb_java.enity.result.roundResult.RoundResultExtendDydbFreeGame;

import java.util.ArrayList;
import java.util.List;

// 客製局結果包裝者一般 大運奪寶免費遊戲
public class RoundResultNormalPgrDydbFreeGame extends AbstractRoundResultNormalPgr {

    public RoundResultNormalPgrDydbFreeGame(ClientRoundResultPgrConfig config, ITableUtil tableUtil) {
    ...
    public RoundResultExtend packageRoundResultExtend(ScreenResult screenResult, RoundHlrResultNormal roundHlrResultNormal) {
        ...
        // 1. 取得畫面倍數陣列
        List<List<Integer>> multiplierMatrix = ((RoundHlrResultExtendDydbFreeGame)roundHlrResultNormal.getRoundHlrResultExtend()).getMultiplierMatrix();
        ...
        // 4. 回傳
        return new RoundResultExtendDydbFreeGame(positionIdToMultiplierList);
    }
}
