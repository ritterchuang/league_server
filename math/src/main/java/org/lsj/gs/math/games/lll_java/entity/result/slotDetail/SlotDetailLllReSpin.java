...
// 虎機詳細記錄父類別
public class SlotDetailLllReSpin extends SlotDetail {
    ...
    public SlotDetailLllReSpin(String reSpinScreenColumn_1, String reSpinScreenColumn_2, String reSpinScreenColumn_3, double reSpinTotalWin) {
