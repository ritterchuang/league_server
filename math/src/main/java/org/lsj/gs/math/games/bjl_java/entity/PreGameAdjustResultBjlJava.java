package org.lsj.gs.math.games.bjl_java.entity;
...
// 新百家樂預遊戲結果
public class PreGameAdjustResultBjlJava extends PreGameAdjustResult {
    private final Map<Integer, List<ICard>> unTakenCardListMap; // 預發牌結果

    public PreGameAdjustResultBjlJava(Map<Integer, List<ICard>> unTakenCardListMap) {
