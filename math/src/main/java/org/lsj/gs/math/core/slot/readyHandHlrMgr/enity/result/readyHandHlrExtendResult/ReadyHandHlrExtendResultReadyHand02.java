...
public class ReadyHandHlrExtendResultReadyHand02 extends ReadyHandHlrExtendResult{
    private final List<Integer> targetSymbolIdList; // 聽牌列表
    private final int columnIndex; // 聽牌輪軸

    public ReadyHandHlrExtendResultReadyHand02(List<Integer> targetSymbolIdList, int columnIndex) {
