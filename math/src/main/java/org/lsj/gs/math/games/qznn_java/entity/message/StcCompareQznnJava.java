...
// 比牌訊息
public class StcCompareQznnJava extends AbstractStcMessageQznnJava {
    ...
    public StcCompareQznnJava(int[][] cards, int[][] lifts, int[] types, double[] scores){
        super(StcCompareQznnJava.class.getCanonicalName());
        this.cards = cards;
        this.lifts = lifts;
        this.types = types;
        this.scores = scores;
