package org.lsj.gs.math.games.sn_java.module.gameStateHlr;
...
import org.lsj.gs.math.games.sn_java.entity.result.gameStateResult.GameStateHlrResultExtendSnBaseGame;
import org.lsj.gs.math.games.sn_java.entity.result.roundResult.RoundHlrResultExtendSnFreeGame;
...
// 水牛免費遊戲處理者
public class GameStateHlrSnFreeGame extends AbstractGameStateHlr implements IGameStateHlr {
    private final LogicSlotNormal logic; // 牌桌邏輯
    private final GameStateConfigExtendSnFreeGame gameStateConfigExtend; // 遊戲狀態額外設定
    private final RoundNormalGameConfigExtendSnFreeGame roundConfigExtend; // 遊戲場次額外設定

    public GameStateHlrSnFreeGame(int conditionId, int gameStateId, ITableUtilSlot tableUtil, ILogicSlot logic, GameStateConfig gameStateConfig) {
        super(conditionId, gameStateId, gameStateConfig, tableUtil);
        this.logic = (LogicSlotNormal) logic;
        this.gameStateConfigExtend = (GameStateConfigExtendSnFreeGame) gameStateConfig.getGameStateConfigExtend();
        this.roundConfigExtend = (RoundNormalGameConfigExtendSnFreeGame) ((RoundConfigNormal)gameStateConfig.getRoundConfig()).getRoundNormalGameConfigExtend();
    }
    ...
    public GameStateHlrResult calculateGameStateHlrResult(int gameStateResultIndex, ConstMathSlot.ReelRtpType reelRtpType, SpinRequest spinRequest, GameStateHlrResult beforeGameStateHlrResult) {
        ...
        return new GameStateHlrResult(
                ...
                new GameStateHlrResultExtendSnBaseGame(),
    ...
    private RoundHlrResultExtend calculateRoundHlrResultExtend(GameCtrResult gameCtrResult, List<List<Integer>> multiplierMatrix) {
        ...
        // 3. 回傳
        return new RoundHlrResultExtendSnFreeGame(multiplierMatrix);
    }
