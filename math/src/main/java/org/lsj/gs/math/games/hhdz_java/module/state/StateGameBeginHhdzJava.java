...
// 遊戲開始狀態
public class StateGameBeginHhdzJava extends AbstractStateHhdzJava {
    private static final Logger LOG = LoggerFactory.getLogger(StateGameBeginHhdzJava.class);
    public StateGameBeginHhdzJava(TableHhdzJava table, LogicHhdzJava logic, RobotLogicHhdzJava aiLogic, GameAdjustHhdzJava gameAdjust, int stateId) {
    ...
    public class TimerTaskRobotAreaBet extends TimerTask {
        private final TableHhdzJava table; // 牌桌
        private final AreaBetResultBaiRen areaBetResult; // 區域押注結果

        public TimerTaskRobotAreaBet(TableHhdzJava table, AreaBetResultBaiRen areaBetResult){
            this.table = table;
