...
// 搶莊牛牛的牛型轉換器
public class NiuStackTmrQznnJava {
    private final Map<ConstNiu.NiuTypeEnumCommon, ConstQznnJava.NiuTypeEnumQznnJava> niuTypeTransformMap; // 牛型轉換表

    public NiuStackTmrQznnJava(Map<ConstNiu.NiuTypeEnumCommon, ConstQznnJava.NiuTypeEnumQznnJava> niuTypeTransformMap) {
        this.niuTypeTransformMap = niuTypeTransformMap;
    }

    // 轉換牛型結構
    public NiuStackQznnJava transformNiuStack(AbstractNiuStack abstractNiuStack){
        return new NiuStackQznnJava(
