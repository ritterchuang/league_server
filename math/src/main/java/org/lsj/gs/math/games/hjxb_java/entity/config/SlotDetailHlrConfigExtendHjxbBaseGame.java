...
// 虎機詳細記錄計算者額外設定黃金西部基礎遊戲
public class SlotDetailHlrConfigExtendHjxbBaseGame extends SlotDetailHlrConfigExtend {
    private final SymbolConfig symbolConfig; // 標誌設定

    public SlotDetailHlrConfigExtendHjxbBaseGame(Map<Integer, String> symbolIdToStringMap, FrameConfig frameConfig, ReelConfig reelConfig, SymbolConfig symbolConfig) {
