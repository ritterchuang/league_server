package org.lsj.gs.math.games.sdzw_java.module.gameStateHlr;
...
import org.lsj.gs.math.games.sdzw_java.enity.result.gameStateResult.GameStateHlrResultExtendSdzwBaseGame;
import org.lsj.utils.MathUtil;

import java.util.ArrayList;

// 聖誕任務虎機 免費遊戲處理者
public class GameStateHlrSdzwFreeGame extends AbstractGameStateHlr implements IGameStateHlr {
    private final LogicSlotNormal logic; // 牌桌邏輯
    private final GameStateConfigExtendSdzwFreeGame gameStateConfigExtend; // 遊戲狀態額外設定
    private final RoundNormalGameConfigExtendSdzwFreeGame roundConfigExtend; // 遊戲場次額外設定

    public GameStateHlrSdzwFreeGame(int conditionId, int gameStateId, ITableUtilSlot tableUtil, ILogicSlot logic, GameStateConfig gameStateConfig) {
        super(conditionId, gameStateId, gameStateConfig, tableUtil);
        this.logic = (LogicSlotNormal) logic;
        this.gameStateConfigExtend = (GameStateConfigExtendSdzwFreeGame) gameStateConfig.getGameStateConfigExtend();
        this.roundConfigExtend = (RoundNormalGameConfigExtendSdzwFreeGame) ((RoundConfigNormal)gameStateConfig.getRoundConfig()).getRoundNormalGameConfigExtend();
    }
