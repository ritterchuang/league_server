...
// 遊戲開始狀態
public class StateGameBeginCjnnJava extends AbstractStateCjnnJava {
    private static final Logger LOG = LoggerFactory.getLogger(StateGameBeginCjnnJava.class);
    public StateGameBeginCjnnJava(TableCjnnJava table, LogicCjnnJava logic, RobotLogicCjnnJava aiLogic, GameAdjustCjnnJava gameAdjust, int stateId) {
    ...
    public class TimerTaskRobotAreaBet extends TimerTask {
        private final TableCjnnJava table; // 牌桌
        private final AreaBetResultBaiRen areaBetResult; // 區域押注結果

        public TimerTaskRobotAreaBet(TableCjnnJava table, AreaBetResultBaiRen areaBetResult){
            this.table = table;
