package org.lsj.gs.math.games.sn_java.entity.config;
...
// 虎機詳細記錄計算者額外設定水牛免費遊戲
public class SlotDetailHlrConfigExtendSnFreeGame extends SlotDetailHlrConfigExtend {
    private final SymbolConfig symbolConfig; // 標誌設定

    public SlotDetailHlrConfigExtendSnFreeGame(Map<Integer, String> symbolIdToStringMap, FrameConfig frameConfig, ReelConfig reelConfig, SymbolConfig symbolConfig) {
