...
// 斷線重連訊息
public class StcCutReturnLznnJava extends AbstractStcMessageLznnJava {
    // 共用參數
    ...
    public StcCutReturnLznnJava(int stage,
                                int leftTime,
                                int[] rates,
                                int banker,
                                int bankerRate,
                                ...
                                int[] types,
                                double[] scores) {
        super(StcCutReturnLznnJava.class.getCanonicalName());
        this.stage = stage;
