package org.lsj.gs.math.games.bszx_java.enity.config;
...
// 虎機詳細記錄計算者額外設定 寶石之星虎機基本遊戲
public class SlotDetailHlrConfigExtendBszxBaseGame extends SlotDetailHlrConfigExtend {
    private final SymbolConfig symbolConfig; // 標誌設定

    public SlotDetailHlrConfigExtendBszxBaseGame(Map<Integer, String> symbolIdToStringMap, FrameConfig frameConfig, ReelConfig reelConfig, SymbolConfig symbolConfig) {
