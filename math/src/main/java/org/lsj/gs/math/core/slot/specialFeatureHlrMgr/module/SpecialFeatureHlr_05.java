...
// 畫面中由左往右連續 3 軸各有1個以上FreeGame_01 Symbol或 Wild_01 Symbol
public class SpecialFeatureHlr_05 extends AbstractSpecialFeatureHlr implements ISpecialFeatureHlr{
    private final int targetNumber = 3; // 目標標誌個數
    private final SpecialFeatureHlrConfig config; // 設定檔
    private final ITableUtil tableUtil; // 牌桌工具包

    public SpecialFeatureHlr_05(SpecialFeatureHlrConfig specialFeatureHlrConfig, ITableUtil tableUtil) {
