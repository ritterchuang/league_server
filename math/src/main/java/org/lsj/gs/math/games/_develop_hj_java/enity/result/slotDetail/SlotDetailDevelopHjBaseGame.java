package org.lsj.gs.math.games._develop_hj_java.enity.result.slotDetail;

import org.lsj.gs.math.core.slot.slotDetailHlrMgr.enity.SlotDetail;

// 虎機詳細記錄模板虎機 基本遊戲
public class SlotDetailDevelopHjBaseGame extends SlotDetail {
    ...
    private final String upperDamp; // 上破框畫面
    private final String lowerDamp; // 下破框畫面

    public SlotDetailDevelopHjBaseGame(double spinCost, double baseGameTotalWin, String screenColumn_1, String screenColumn_2, String screenColumn_3, String screenColumn_4, String screenColumn_5, String upperDamp, String lowerDamp) {
        ...
        this.upperDamp = upperDamp;
        this.lowerDamp = lowerDamp;
    }
    ...
    public String getUpperDamp() {
        return upperDamp;
    }

    public String getLowerDamp() {
        return lowerDamp;
    }
}
