...
// 虎機詳細記錄父類別
public class SlotDetailSbxcReSpin extends SlotDetail {
    ...
    public SlotDetailSbxcReSpin(String reSpinScreenColumn_1, String reSpinScreenColumn_2, String reSpinScreenColumn_3, double reSpinTotalWin) {
