...
// 下注計算器遊戲設定 BetType01
public class QzBetCtrGameConfigBetType01 extends QzBetCtrGameConfig {
    ...
    public QzBetCtrGameConfigBetType01(ConstMathCard.QzBetType qzBetType, int maxRate, int minRate, int specifyRate, int thresholdValue) {
        super(qzBetType);
