...
// 客製局結果包裝者一般 水牛基礎遊戲
public class RoundResultNormalPgrSnBaseGame extends AbstractRoundResultNormalPgr {

    public RoundResultNormalPgrSnBaseGame(ClientRoundResultPgrConfig config, ITableUtil tableUtil) {
