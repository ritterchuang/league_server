...
// 斷線重連訊息
public class StcCutReturnQznnJava extends AbstractStcMessageQznnJava {
    // 共用參數
    ...
    public StcCutReturnQznnJava(int stage,
                                int leftTime,
                                int[] rates,
                                int banker,
                                int bankerRate,
                                ...
                                int[] types,
                                double[] scores) {
        super(StcCutReturnQznnJava.class.getCanonicalName());
        this.stage = stage;
