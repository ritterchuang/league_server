...
// 畫面中恰有4欄有 FreeGame_01
public class SpecialFeatureHlr_03 extends AbstractSpecialFeatureHlr implements ISpecialFeatureHlr{
    private final int targetNumber = 4; // 目標標誌個數
    private final SpecialFeatureHlrConfig config; // 設定檔
    private final ITableUtil tableUtil; // 牌桌工具包

    public SpecialFeatureHlr_03(SpecialFeatureHlrConfig specialFeatureHlrConfig, ITableUtil tableUtil) {
