package org.lsj.gs.math.games.zcjz_java.module.gameStateHlr;
...
import org.lsj.gs.math.core.slot.mathSlotConfigHlr.enity.sever.roundConfig.roundNormalGameConfig.RoundNormalGameConfigExtendZcjzBaseGame;
...
import org.lsj.gs.math.games.zcjz_java.entity.result.gameStateResult.GameStateHlrResultExtendZcjzBaseGame;
...
// 招財金豬基礎遊戲處理者
public class GameStateHlrZcjzBaseGame extends AbstractGameStateHlr implements IGameStateHlr {
    private final LogicSlotNormal logic; // 牌桌邏輯
    private final GameStateConfigExtendZcjzBaseGame gameStateConfigExtend; // 遊戲狀態額外設定
    private final RoundNormalGameConfigExtendZcjzBaseGame roundConfigExtend; // 遊戲場次額外設定
    private final IFiniteAwardPoolHlr finiteAwardPoolHlr; // 有限獎項處理者

    public GameStateHlrZcjzBaseGame(int conditionId, int gameStateId, ITableUtilSlot tableUtil, ILogicSlot logic, IFiniteAwardPoolHlr finiteAwardPoolHlr, GameStateConfig gameStateConfig) {
        super(conditionId, gameStateId, gameStateConfig, tableUtil);
        this.logic = (LogicSlotNormal)logic;
        this.gameStateConfigExtend = (GameStateConfigExtendZcjzBaseGame) gameStateConfig.getGameStateConfigExtend();
        this.roundConfigExtend = (RoundNormalGameConfigExtendZcjzBaseGame) ((RoundConfigNormal)gameStateConfig.getRoundConfig()).getRoundNormalGameConfigExtend();
    ...
    public GameStateHlrResult calculateGameStateHlrResult(int gameStateResultIndex, ConstMathSlot.ReelRtpType reelRtpType, SpinRequest spinRequest, GameStateHlrResult beforeGameStateHlrResult) {
        ...
        return new GameStateHlrResult(
                ...
                new GameStateHlrResultExtendZcjzBaseGame(),
    ...
    private RoundHlrResultExtend calculateRoundHlrResultExtend(int conditionId, List<DampScreenBox> dampScreenBoxList) {
       ...
       List<Integer> reSpinReelStrip = this.getReSpinReelStrip(reSpinScreenGtrResult.getReelCtrResult().getReelId());
        ...
        // 5. 回傳
        return new RoundHlrResultExtendZcjzBaseGame(
