...
// 搶莊結果訊息
public class StcVieResultZjhJava extends AbstractStcMessageZjhJava {
    @JsonIgnore public int banker; // 莊家位置
    @JsonIgnore public int bankerRate; // 莊家倍數
    @JsonIgnore public int[] viers; // 競爭莊家位置

    public StcVieResultZjhJava(int banker, int bankerRate, int[] viers) {
        super(StcVieResultZjhJava.class.getCanonicalName());
        this.banker = banker;
