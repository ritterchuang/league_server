package org.lsj.gs.math.games.xzcq_java.entity.result.slotDetail;

import org.lsj.gs.math.core.slot.slotDetailHlrMgr.enity.SlotDetail;

// 虎機詳細記錄父類別
public class SlotDetailXzcqBaseGame extends SlotDetail {
    ...
    public SlotDetailXzcqBaseGame(double spinCost, String screenColumn_1, String screenColumn_2, String screenColumn_3, double baseGameTotalWin) {
