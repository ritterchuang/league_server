...
// 客製局結果包裝者一般 寶石之星免費遊戲
public class RoundResultNormalPgrBszxFreeGame extends AbstractRoundResultNormalPgr {

    public RoundResultNormalPgrBszxFreeGame(ClientRoundResultPgrConfig config, ITableUtil tableUtil) {
