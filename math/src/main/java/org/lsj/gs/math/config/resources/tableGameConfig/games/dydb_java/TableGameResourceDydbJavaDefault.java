package org.lsj.gs.math.config.resources.tableGameConfig.games.dydb_java;
...
import org.lsj.gs.math.core.slot.mathSlotConfigHlr.enity.sever.roundConfig.roundNormalGameConfig.RoundNormalGameConfigExtendDydbBaseGame;
import org.lsj.gs.math.core.slot.mathSlotConfigHlr.enity.sever.roundConfig.roundNormalGameConfig.RoundNormalGameConfigExtendDydbFreeGame;
...
import org.lsj.gs.math.games.dydb_java.enity.config.GameStateConfigExtendDydbBaseGame;
import org.lsj.gs.math.games.dydb_java.enity.config.GameStateConfigExtendDydbFreeGame;
...
// 大運奪寶老虎機牌桌遊戲設定產生器
public class TableGameResourceDydbJavaDefault extends AbstractTableGameResourceSlot {
    ...
    public TableGameConfigSlot create() {
        ...
        // 7. 設定遊戲狀態設定
        GameStateConfig dydbBaseGameStateConfig = new GameStateConfig(
                ConstMathSlot.GameStateType.DYDB_BASEGAME, new GameStateConfigExtendDydbBaseGame(), new GameStateInputConfig(ConstMathSlot.GameStateInputType.NONE, new GameStateInputConfigExtendNone()), ConstMathSlot.RoundType.NORMAL, new RoundConfigNormal(
                new ReelConfig(
                ...
                new RoundNormalGameConfigExtendDydbBaseGame()

        ), ConstMathSlot.SlotDetailType.DYDB_BASEGAME
        );
        GameStateConfig dydbFreeGameStateConfig = new GameStateConfig(
                ConstMathSlot.GameStateType.DYDB_FREEGAME, new GameStateConfigExtendDydbFreeGame(), new GameStateInputConfig(ConstMathSlot.GameStateInputType.NONE, new GameStateInputConfigExtendNone()), ConstMathSlot.RoundType.NORMAL, new RoundConfigNormal(
                        new ReelConfig(
                                ConstMathSlot.ReelType.REEL_DEPENDENT,
                                new ArrayList<>(){
                                    {
                ...
                new PayTableConfig(new ArrayList<>(){
                    {
                        ...
                        new RoundNormalGameConfigExtendDydbFreeGame(
                                0,
                                List.of(
                                        List.of(0),
                                        List.of(2,3),
        ...
        GameStateConfigCluster gameStateConfigCluster = new GameStateConfigCluster(
                ...
                new ArrayList<>(){
                    {
                        add(
                                dydbBaseGameStateConfig
                        );
                        add(
                                dydbFreeGameStateConfig
                        );
                    }
                } // 遊戲狀態設定列表
        );
