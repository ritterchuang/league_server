...
// 聽牌處理者額外結果 ReadyHand05
public class ReadyHandHlrExtendResultReadyHand05 extends ReadyHandHlrExtendResult{
    private final List<Integer> targetSymbolIdList; // 聽牌列表
    private final int columnIndex; // 聽牌輪軸

    public ReadyHandHlrExtendResultReadyHand05(List<Integer> targetSymbolIdList, int columnIndex) {
