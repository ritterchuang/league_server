...
// 畫面中恰有3欄有 FreeGame_01
public class SpecialFeatureHlr_02 extends AbstractSpecialFeatureHlr implements ISpecialFeatureHlr{
    private final int targetNumber = 3; // 目標標誌個數
    private final SpecialFeatureHlrConfig config; // 設定檔
    private final ITableUtil tableUtil; // 牌桌工具包

    public SpecialFeatureHlr_02(SpecialFeatureHlrConfig specialFeatureHlrConfig, ITableUtil tableUtil) {
