...
import org.lsj.gs.math.games.sn_java.entity.result.roundResult.RoundResultExtendSnFreeGame;

import java.util.ArrayList;
import java.util.List;

// 客製局結果包裝者一般 水牛免費遊戲
public class RoundResultNormalPgrSnFreeGame extends AbstractRoundResultNormalPgr {

    public RoundResultNormalPgrSnFreeGame(ClientRoundResultPgrConfig config, ITableUtil tableUtil) {
    ...
    public RoundResultExtend packageRoundResultExtend(ScreenResult screenResult, RoundHlrResultNormal roundHlrResultNormal) {
        ...
        // 1. 取得畫面倍數陣列
        List<List<Integer>> multiplierMatrix = ((RoundHlrResultExtendSnFreeGame)roundHlrResultNormal.getRoundHlrResultExtend()).getMultiplierMatrix();
        ...
        // 4. 回傳
        return new RoundResultExtendSnFreeGame(positionIdToMultiplierList);
    }
}
