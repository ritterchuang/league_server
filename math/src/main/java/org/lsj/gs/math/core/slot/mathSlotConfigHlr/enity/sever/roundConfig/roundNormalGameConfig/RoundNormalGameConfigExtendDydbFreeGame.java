...
// 一般遊戲局額外設定大運奪寶免費遊戲
public class RoundNormalGameConfigExtendDydbFreeGame extends RoundNormalGameConfigExtend{
    ...
    public RoundNormalGameConfigExtendDydbFreeGame(int targetSymbolId, List<List<Integer>> multiplierList, List<List<Integer>> weightList) {
