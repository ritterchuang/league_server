package org.lsj.gs.math.games.wl_java.enity.result.slotDetail;

import org.lsj.gs.math.core.slot.slotDetailHlrMgr.enity.SlotDetail;

// 虎機詳細記錄 旺來免費遊戲
public class SlotDetailWlFreeGame extends SlotDetail {
    ...
    public SlotDetailWlFreeGame(int roundIndex, int totalRound, double roundTotalWin, String screenColumn_1, String screenColumn_2, String screenColumn_3, String screenColumn_4, String screenColumn_5, String multiplier_2, String multiplier_3, String multiplier_4) {
