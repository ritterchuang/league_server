...
// 客製局結果包裝者一般 仙境探寶基礎遊戲
public class RoundResultNormalPgrXjtbBaseGame extends AbstractRoundResultNormalPgr {

    public RoundResultNormalPgrXjtbBaseGame(ClientRoundResultPgrConfig config, ITableUtil tableUtil) {
