package org.lsj.gs.math.games.swzs_java.entity.result.slotDetail;

import org.lsj.gs.math.core.slot.slotDetailHlrMgr.enity.SlotDetail;

// 虎機詳細記錄 死亡之書虎機免費遊戲
public class SlotDetailSwzsFreeGame extends SlotDetail {
    ...
    public SlotDetailSwzsFreeGame(int roundIndex, int totalRound, double totalWin, String screenColumn_1, String screenColumn_2, String screenColumn_3, String screenColumn_4, String screenColumn_5) {
