package org.lsj.gs.math.games.olldbz_java.entity.config;
...
// 虎機詳細記錄計算者額外設定 歐賴利的寶藏虎機免費遊戲
public class SlotDetailHlrConfigExtendOlldbzFreeGame extends SlotDetailHlrConfigExtend {
    private final SymbolConfig symbolConfig; // 標誌設定

    public SlotDetailHlrConfigExtendOlldbzFreeGame(Map<Integer, String> symbolIdToStringMap, FrameConfig frameConfig, ReelConfig reelConfig, SymbolConfig symbolConfig) {
