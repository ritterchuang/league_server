...
// 遊戲開始狀態
public class StateGameBeginLhdJava extends AbstractStateLhdJava {
    private static final Logger LOG = LoggerFactory.getLogger(StateGameBeginLhdJava.class);
    public StateGameBeginLhdJava(TableLhdJava table, LogicLhdJava logic, RobotLogicLhdJava aiLogic, GameAdjustLhdJava gameAdjust, int stateId) {
    ...
    public class TimerTaskRobotAreaBet extends TimerTask {
        private final TableLhdJava table; // 牌桌
        private final AreaBetResultBaiRen areaBetResult; // 區域押注結果

        public TimerTaskRobotAreaBet(TableLhdJava table, AreaBetResultBaiRen areaBetResult){
            this.table = table;
