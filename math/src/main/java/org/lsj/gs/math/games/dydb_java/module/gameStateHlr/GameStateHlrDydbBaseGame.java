package org.lsj.gs.math.games.dydb_java.module.gameStateHlr;
...
import org.lsj.gs.math.games.dydb_java.enity.result.gameStateResult.GameStateHlrResultExtendDydbBaseGame;
import org.lsj.utils.MathUtil;

import java.util.ArrayList;

// 大運奪寶基礎遊戲處理者
public class GameStateHlrDydbBaseGame extends AbstractGameStateHlr implements IGameStateHlr {
    private final LogicSlotNormal logic; // 牌桌邏輯
    private final GameStateConfigExtendDydbBaseGame gameStateConfigExtend; // 遊戲狀態額外設定
    private final RoundNormalGameConfigExtendDydbBaseGame roundConfigExtend; // 遊戲場次額外設定

    public GameStateHlrDydbBaseGame(int conditionId, int gameStateId, ITableUtilSlot tableUtil, ILogicSlot logic, GameStateConfig gameStateConfig) {
        super(conditionId, gameStateId, gameStateConfig, tableUtil);
        this.logic = (LogicSlotNormal) logic;
        this.gameStateConfigExtend = (GameStateConfigExtendDydbBaseGame) gameStateConfig.getGameStateConfigExtend();
        this.roundConfigExtend = (RoundNormalGameConfigExtendDydbBaseGame) ((RoundConfigNormal)gameStateConfig.getRoundConfig()).getRoundNormalGameConfigExtend();
    }
