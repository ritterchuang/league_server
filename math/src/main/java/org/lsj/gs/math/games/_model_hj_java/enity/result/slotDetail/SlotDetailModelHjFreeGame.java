package org.lsj.gs.math.games._model_hj_java.enity.result.slotDetail;

import org.lsj.gs.math.core.slot.slotDetailHlrMgr.enity.SlotDetail;

// 虎機詳細記錄 模板虎機免費遊戲
public class SlotDetailModelHjFreeGame extends SlotDetail {
    ...
    public SlotDetailModelHjFreeGame(int roundIndex, int totalRound, double totalWin, String screenColumn_1, String screenColumn_2, String screenColumn_3, String screenColumn_4, String screenColumn_5) {
