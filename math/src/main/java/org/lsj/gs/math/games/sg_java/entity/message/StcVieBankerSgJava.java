...
// 玩家搶莊訊息
public class StcVieBankerSgJava extends AbstractStcMessageSgJava {
    @JsonIgnore public int chair; // 座位
    @JsonIgnore public int rate; // 搶莊倍數

    public StcVieBankerSgJava(int chair, int rate) {
        super(StcVieBankerSgJava.class.getCanonicalName());
        this.chair = chair;
        this.rate = rate;
