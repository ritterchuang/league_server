package org.lsj.gs.math.games.sdzw_java.enity.result.slotDetail;

import org.lsj.gs.math.core.slot.slotDetailHlrMgr.enity.SlotDetail;

// 虎機詳細記錄 聖誕任務虎機免費遊戲
public class SlotDetailSdzwFreeGame extends SlotDetail {
    ...
    public SlotDetailSdzwFreeGame(int roundIndex, int totalRound, double roundTotalWin, String screenColumn_1, String screenColumn_2, String screenColumn_3, String screenColumn_4, String screenColumn_5) {
