...
// 虎機詳細記錄計算者額外設定 歐賴利的寶藏虎機基本遊戲
public class SlotDetailHlrConfigExtendOlldbzBaseGame extends SlotDetailHlrConfigExtend {
    private final SymbolConfig symbolConfig; // 標誌設定

    public SlotDetailHlrConfigExtendOlldbzBaseGame(Map<Integer, String> symbolIdToStringMap, FrameConfig frameConfig, ReelConfig reelConfig, SymbolConfig symbolConfig) {
