...
// 消除處理者額外設定 麻將胡了
public class CascadeHlrConfigExtendMjhl extends CascadeHlrConfigExtend{
    private final CascadeScreenGtrConfig cascadeScreenGtrConfig; // 消除畫面生產器設定
    private final SymbolConfig symbolConfig; // 標誌設定檔

    public CascadeHlrConfigExtendMjhl(CascadeScreenGtrConfig cascadeScreenGtrConfig, SymbolConfig symbolConfig) {
