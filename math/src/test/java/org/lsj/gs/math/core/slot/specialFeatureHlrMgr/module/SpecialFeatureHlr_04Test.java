...
// 特殊事件處理者04 測試 [畫面中恰有 5 欄有 FreeGame_01]
@ExtendWith(MockitoExtension.class)
class SpecialFeatureHlr_04Test {
    ...
    @BeforeEach
    void initHlr() {
        this.specialFeatureHlr = new SpecialFeatureHlr_04(this.generateSpecialFeatureHlrConfig(), mockTableUtil);
    }
