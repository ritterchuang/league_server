...
// 特殊事件處理者06 測試 [畫面中由左往右連續 4 軸各有1個以上FreeGame_01 Symbol或 Wild_01 Symbol]
@ExtendWith(MockitoExtension.class)
class SpecialFeatureHlr_06Test {
    ...
    @BeforeEach
    void initHlr() {
        this.specialFeatureHlr = new SpecialFeatureHlr_06(this.generateSpecialFeatureHlrConfig(), mockTableUtil);
    }
    ...
    void test_given_hitScreenWithTrigger_when_calculateSpecialFeatureHlrResult_then_correct() {
        ...
        SpecialFeatureHlrResult expectResult = new SpecialFeatureHlrResult(
                ConstMathSlot.SpecialFeatureType.SF_06,
    ...
    private SpecialFeatureHlrConfig generateSpecialFeatureHlrConfig() {
        return new SpecialFeatureHlrConfig(
                ...
                new SpecialFeatureConfig(ConstMathSlot.SpecialFeatureType.SF_06, ConstMathSlot.TriggerEvent.TRIGGER_01, 2));
    }
