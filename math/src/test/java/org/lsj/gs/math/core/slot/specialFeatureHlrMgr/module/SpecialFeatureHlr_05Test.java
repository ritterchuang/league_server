...
// 特殊事件處理者05 測試 [畫面中由左往右連續 3 軸各有1個以上FreeGame_01 Symbol或 Wild_01 Symbol]
@ExtendWith(MockitoExtension.class)
class SpecialFeatureHlr_05Test {
    ...
    @BeforeEach
    void initHlr() {
        this.specialFeatureHlr = new SpecialFeatureHlr_05(this.generateSpecialFeatureHlrConfig(), mockTableUtil);
    }
    ...
    void test_given_hitScreenWithTrigger_when_calculateSpecialFeatureHlrResult_then_correct() {
        ...
        SpecialFeatureHlrResult expectResult = new SpecialFeatureHlrResult(
                ConstMathSlot.SpecialFeatureType.SF_05,
    ...
    private SpecialFeatureHlrConfig generateSpecialFeatureHlrConfig() {
        return new SpecialFeatureHlrConfig(
                ...
                new SpecialFeatureConfig(ConstMathSlot.SpecialFeatureType.SF_05, ConstMathSlot.TriggerEvent.TRIGGER_01, 2));
    }
