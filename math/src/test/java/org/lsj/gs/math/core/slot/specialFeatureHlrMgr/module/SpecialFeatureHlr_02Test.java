...
// 特殊事件處理者02 測試 [畫面中恰有 3 欄有 FreeGame_01]
@ExtendWith(MockitoExtension.class)
class SpecialFeatureHlr_02Test {
    ...
    @BeforeEach
    void initHlr() {
        this.specialFeatureHlr = new SpecialFeatureHlr_02(this.generateSpecialFeatureHlrConfig(), mockTableUtil);
    }
