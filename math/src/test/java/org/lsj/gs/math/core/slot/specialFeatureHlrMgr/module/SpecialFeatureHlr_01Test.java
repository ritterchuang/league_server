...
// 特殊事件處理者01 測試 [畫面中恰有 2 欄有 FreeGame_01]
@ExtendWith(MockitoExtension.class)
class SpecialFeatureHlr_01Test {
    ...
    @BeforeEach
    void initHlr() {
        this.specialFeatureHlr = new SpecialFeatureHlr_01(this.generateSpecialFeatureHlrConfig(), mockTableUtil);
    }
